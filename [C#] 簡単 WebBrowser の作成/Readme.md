...
<pre class="hidden"><code class="csharp">// Uri の設定
Uri nextUri = new Uri(&quot;http://msdn.microsoft.com/ja-jp/samplecode.recipe.aspx&quot;);
// ナビゲート
this.webBrowser1.Navigate(nextUri);</code></pre>
<pre id="codePreview" class="csharp"><code class="csharp">// Uri の設定
Uri nextUri = new Uri(&quot;http://msdn.microsoft.com/ja-jp/samplecode.recipe.aspx&quot;);
// ナビゲート
this.webBrowser1.Navigate(nextUri);</code></pre>
</div>
...
<a href="http://msdn.microsoft.com/ja-jp/netframework/gg317717.aspx">[C#] Windows フォームによるクライアント アプリケーション開発</a>を参照してください。</p>
<ol>
<li>Windows フォーム アプリケーション プロジェクトを作成し、フォームに ComboBox と WebBrowser コントロールを追加します。ComboBox の Dock プロパティは Top と設定します。
<p style="margin-top:10px"><img src="15392-image.png" alt=""></p>
...
<p style="margin-top:10px"><img src="15393-image.png" alt=""></p>
</li></ol>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
...
<ol>
<p style="margin-top:10px"><img src="15394-image.png" alt=""></p>
</ol>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
...
<p><img src="15395-image.png" alt=""></p>
<p>その他、コンボボックスに今まで表示された Url をリスト形式にて追加し、あとで選択できるようにする機能や、フォームのタイトルにドキュメントのタイトルを表示させる方法については
<a href="http://msdn.microsoft.com/ja-jp/netframework/dd283298.aspx">10 行でズバリ!! 簡単 WebBrowser の作成 (C#)</a> において解説されていますのでこちらもご確認ください。</p>
<h3>関連リンク</h3>
<ul>
...
</li><li><a href="http://msdn.microsoft.com/ja-jp/netframework/dd283298.aspx">10 行でズバリ!! 簡単 WebBrowser の作成 (C#)</a>
</li></ul>
...
<p style="margin-top:20px"><a href="#top"><img src="15397-image.png" alt=""> ページのトップへ</a></p>
</div>
</div>
