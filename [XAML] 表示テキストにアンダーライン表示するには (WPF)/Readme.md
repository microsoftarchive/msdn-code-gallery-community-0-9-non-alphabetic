...
<pre class="hidden"><code class="csharp">&lt;Window x:Class=&quot;TextBlock_WPF02.Window1&quot;
    xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
    xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
    Title=&quot;Window1&quot; Height=&quot;400&quot; Width=&quot;300&quot;&gt;
    &lt;StackPanel x:Name=&quot;LayoutRoot&quot;&gt;

        &lt;!--TextBlockにアンダーラインを引くにはTextDecorationsプロパティを設定--&gt;
        &lt;TextBlock FontSize=&quot;20&quot; Margin=&quot;20&quot; TextDecorations=&quot;Underline&quot;&gt;Abcdef&lt;/TextBlock&gt;

        &lt;!--Runにも設定可能で、アンダーライン以外にも指定可能--&gt;
        &lt;TextBlock FontSize=&quot;20&quot; Margin=&quot;20&quot;&gt;
            &lt;Run TextDecorations=&quot;Overline&quot;&gt;Overline&lt;/Run&gt;&lt;LineBreak /&gt;
            &lt;Run TextDecorations=&quot;Strikethrough&quot;&gt;Strikethrough&lt;/Run&gt;&lt;LineBreak /&gt;
            &lt;Run TextDecorations=&quot;BaseLine&quot;&gt;BaseLine&lt;/Run&gt;&lt;LineBreak /&gt;
            &lt;Run TextDecorations=&quot;Underline&quot;&gt;Underline&lt;/Run&gt;&lt;LineBreak /&gt;
        &lt;/TextBlock&gt;
        
        &lt;!--インラインにUnderlineを指定することでも書式設定が可能--&gt;
        &lt;TextBlock FontSize=&quot;20&quot;&gt;
            &lt;Underline&gt;アンダーライン&lt;/Underline&gt;&lt;LineBreak /&gt;
            &lt;Bold&gt;強調&lt;/Bold&gt;&lt;LineBreak /&gt;
            &lt;Italic&gt;斜体&lt;/Italic&gt;
        &lt;/TextBlock&gt;
    &lt;/StackPanel&gt;
&lt;/Window&gt;</code></pre>
<pre id="codePreview" class="xaml"><code class="csharp">&lt;Window x:Class=&quot;TextBlock_WPF02.Window1&quot;
    xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
    xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
    Title=&quot;Window1&quot; Height=&quot;400&quot; Width=&quot;300&quot;&gt;
    &lt;StackPanel x:Name=&quot;LayoutRoot&quot;&gt;
...
<h2>実行結果</h2>
<p><img src="15665-image.png" alt=""></p>
<h2>ポイント</h2>
<p>TextBlock でアンダーラインを表示方法は 2 通りあります。1 つは TextDecorations プロパティを使用する方法、もう 1 つは Underline 要素を利用する方法です。</p>
<p>TextDecorations プロパティは下線 (Underline)、ベースライン (BaseLine)、取り消し線 (Strikethrough)、上線 (Overline)の 4 種類が指定可能です。既定ではなにも設定されていませんが TextBlock、もしくは Run 要素に指定することで各種ラインを指定することが可能です。</p>
<p>次に Underline 要素を利用する方法ですが、アンダーラインを指定したい文字列を Underline でブロック化すると指定したテキストにアンダーラインを表示します。ほかにも Inline で指定できる書式等を追加することが可能です。</p>
<h2>参考</h2>
<p>TextDecorations プロパティ<br>
<a href="http://msdn.microsoft.com/ja-jp/library/system.windows.controls.textblock.textdecorations.aspx">http://msdn.microsoft.com/ja-jp/library/system.windows.controls.textblock.textdecorations.aspx</a></p>
