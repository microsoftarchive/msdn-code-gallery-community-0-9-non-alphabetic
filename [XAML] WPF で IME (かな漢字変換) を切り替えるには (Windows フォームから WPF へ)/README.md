...
<hr>
<p>&nbsp;WPF の TextBox には、Windows フォームのような ImeMode プロパティがありません。代わりに InputMethod の添付プロパティ使います。</p>
<h2>Code [XAML]</h2>
<div style="margin:0px 0px 20px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>&lt;Window x:Class=&quot;WpfImeApplication.MainWindow&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Title=&quot;MainWindow&quot; Height=&quot;300&quot; Width=&quot;400&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&lt;StackPanel&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- IME の状態を変えない --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.PreferredImeState=&quot;DoNotCare&quot;&nbsp;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- IME を有効にする --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.PreferredImeState=&quot;On&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- IME を無効にする --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.PreferredImeState=&quot;Off&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- IME を抑止する --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.IsInputMethodSuspended=&quot;True&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- 全角ひらがな --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.PreferredImeState=&quot;On&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;InputMethod.PreferredImeConversionMode=&quot;FullShape,Native&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- 全角カタカナ --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.PreferredImeState=&quot;On&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;InputMethod.PreferredImeConversionMode=&quot;FullShape,Katakana&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- 半角カタカナ --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.PreferredImeState=&quot;On&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;InputMethod.PreferredImeConversionMode=&quot;Native&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- 全角英字 --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.PreferredImeState=&quot;On&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;InputMethod.PreferredImeConversionMode=&quot;FullShape,Alphanumeric&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- 半角英字 --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox InputMethod.PreferredImeState=&quot;On&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;InputMethod.PreferredImeConversionMode=&quot;Alphanumeric&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&lt;/StackPanel&gt;<br>
&lt;/Window&gt;</p>
</div>
<h2 style="margin-top:30px">実行結果</h2>
<p><img src="15645-image.png" alt=""></p>
<h2 style="margin-top:30px">ポイント</h2>
<p>Windows フォームでは、IME (かな漢字変換) を制御するためにコントロールごとに ImeMode というプロパティが用意されていましたが、WPF では IME のような入力方法を制御するために InputMethod というクラスが用意されています。たとえば、現在の IME の状態を取得したり、設定したりするためには InputMethod.Current (現在アクティブな入力方法) の ImeState というプロパティを使います。</p>
<p>また、入力用のコントロールでは、添付プロパティを使って、コントロールにおける IME の状態を指定できます。Windows フォームの ImeMode プロパティの値に相当する設定を以下に示します。</p>
<table class="grid" border="1" cellspacing="0" cellpadding="5" width="615" style="border-collapse:collapse; margin-bottom:10px">
<tbody>
<tr>
<td align="center" valign="middle" style="background-color:#4f81bd"><span style="color:#ffffff"><strong>ImeMode</strong></span></td>
<td align="center" valign="middle" style="background-color:#4f81bd"><span style="color:#ffffff"><strong>InputMethod の設定</strong></span></td>
</tr>
<tr>
<td align="center"><strong>NoControl</strong></td>
<td valign="top">InputMethod.PreferredImeState=&quot;DoNotCare&quot;</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>On</strong></td>
<td valign="top">InputMethod.PreferredImeState=&quot;On&quot;</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Off</strong></td>
<td valign="top">InputMethod.PreferredImeState=&quot;Off&quot;</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Disable</strong></td>
<td valign="top">InputMethod.IsInputMethodSuspended=&quot;True&quot;</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Hiragana</strong></td>
<td valign="top">InputMethod.PreferredImeState=&quot;On&quot;<br>
InputMethod.PreferredImeConversionMode=&quot;FullShape,Native&quot;</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Katakana</strong></td>
<td valign="top">InputMethod.PreferredImeState=&quot;On&quot;<br>
InputMethod.PreferredImeConversionMode=&quot;FullShape,Katakana&quot;</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>KatakanaHalf</strong></td>
<td valign="top">InputMethod.PreferredImeState=&quot;On&quot;<br>
InputMethod.PreferredImeConversionMode=&quot;Native&quot;</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>AlphaFull</strong></td>
<td valign="top">InputMethod.PreferredImeState=&quot;On&quot;<br>
InputMethod.PreferredImeConversionMode=&quot;FullShape,Alphanumeric&quot;</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Alpha</strong></td>
<td valign="top">InputMethod.PreferredImeState=&quot;On&quot;<br>
InputMethod.PreferredImeConversionMode=&quot;Alphanumeric&quot;</td>
</tr>
</tbody>
</table>
<p>InputMethod クラスの詳細については「<a href="http://msdn.microsoft.com/ja-jp/library/ms617141">InputMethod クラス</a>」を参照してください</p>
