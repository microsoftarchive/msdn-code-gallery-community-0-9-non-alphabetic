...
<hr>
<p>System.Text.RegularExpressions.Regex クラスに実装されている Replace メソッドを用いることで正規表現を用いて条件に一致した文字列を指定の文字列に置換することができます。正規表現については<a href="http://msdn.microsoft.com/ja-jp/library/hs600312.aspx">こちら</a>を参考にしてください。</p>
...
<pre class="hidden"><code class="csharp">Imports System.Text.RegularExpressions
Module Module1
    Sub Main()
    ...
    End Sub
End Module</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Imports System.Text.RegularExpressions
Module Module1
    Sub Main()
        Dim sampleStr As String = &quot;&lt;title&gt;逆引きサンプル コード&lt;/title&gt;&quot;
        Dim patternStr As String = &quot;&lt;.*?&gt;&quot;
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Console.WriteLine(Regex.Replace(sampleStr, patternStr, String.Empty, RegexOptions.Singleline))</code></pre>
