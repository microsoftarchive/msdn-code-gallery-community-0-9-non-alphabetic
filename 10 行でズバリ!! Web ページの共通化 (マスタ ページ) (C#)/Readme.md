# 10 行でズバリ!! Web ページの共通化 (マスタ ページ) (C#)
## Requires
- 
## License
...
<h2><img src="13867-image.png" alt=""> このコンテンツのポイント</h2>
<ul>
<li>複数の Web ページで共通的なデザインや機能をテンプレート化する方法を理解する。 </li></ul>
<h2><img src="13868-image.png" alt=""> 今回紹介するコード</h2>
<table border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td colspan="2">＜Page2.aspx.cs＞</td>
</tr>
</tbody>
</table>
...
{
    TextBox textBox1OfMasterPage;
    textBox1OfMasterPage = (TextBox)Master.FindControl(&quot;TextBox1&quot;);
...
<h3><img src="13869-image.png" alt=""> 今回のシステム要件</h3>
<ul>
...
<h3>目次</h3>
<p><a href="#masterpage_cs1">はじめに</a><br>
<a href="#masterpage_cs2">作成するサンプル アプリケーションの説明</a><br>
<a href="#masterpage_cs3">マスタ ページの作成</a><br>
<a href="#masterpage_cs4">コンテンツ ページの作成</a><br>
<a href="#masterpage_cs5">動作確認</a><br>
<a href="#masterpage_cs6">マスタ ページのデータを取得する</a><br>
<a href="#masterpage_cs7">おわりに</a><br>
<a href="#masterpage_cs8">補足事項</a></p>
<table class="grid" border="0" cellspacing="0" cellpadding="5" bgcolor="#e5f1f8" style="border-collapse:collapse; margin-bottom:10px">
<tbody>
<tr>
<td colspan="2">Visual Basic の内容はこちらに掲載しています。</td>
</tr>
<tr>
<td align="center"><img src="13870-image.png" alt=""></td>
<td><a href="http://msdn.microsoft.com/ja-jp/netframework/31eef1c8-6e47-41b9-98f6-60cec840fe9c">10 行でズバリ!! Web ページの共通化 (マスタ ページ) (VB)</a></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
<hr>
<h2 id="masterpage_cs1">はじめに</h2>
...
<h2 id="masterpage_cs2">作成するサンプル アプリケーションの説明</h2>
<p>ここでは、共通的なデザインを持つ 1 つのマスタ ページを作成し、2 つの Web ページでこれを共有します。</p>
<p><img src="13871-image.png" alt=""> <br>
Web ページ 1 (Page1.aspx)</p>
<p><img src="13872-image.png" alt=""> <br>
Web ページ 2 (Page2.aspx)</p>
<p><strong>図 1. マスタ ページを活用した Web ページの例</strong></p>
<p>まず初めに、事前準備として、新しい Web サイトを作成します。<br>
Web サイトの新規作成方法については、「<a href="http://msdn.microsoft.com/ja-jp/netframework/f80edada-5bc0-43a6-8d8a-026e304858dc">10 行でズバリ !! ASP.NET Web フォームによる Web アプリケーション開発 (C#)</a>」 を参考にして下さい。</p>
<h2 id="masterpage_cs3">マスタ ページの作成</h2>
...
<p><img src="13873-image.png" alt=""></p>
...
<p><img src="13874-image.png" alt=""></p>
<p><strong>図 3. マスタ ページのデザイン</strong></p>
<h2 id="masterpage_cs4">コンテンツ ページの作成</h2>
...
<p><img src="13875-image.png" alt=""></p>
...
<p><img src="13876-image.png" alt=""></p>
...
<p><img src="13877-image.png" alt=""></p>
...
<p><img src="13878-image.png" alt=""></p>
<p><strong>図 7. コンテンツ ページのデザイン (Page 1)</strong></p>
<h2 id="masterpage_cs5">動作確認</h2>
<p>それでは実行してみましょう。</p>
...
<p><img src="13880-image.png" alt=""></p>
...
<p><img src="13881-image.png" alt=""></p>
<p><strong>図 10. 実行結果 (Page2.aspx)</strong></p>
<h2 id="masterpage_cs7">おわりに</h2>
...
<ol>
<li>まず、先頭行に Master ディレクティブ (&lt;%@Master ...%&gt;) があることを確認することができます。
<table cellpadding="5">
<tbody>
<tr>
<td bgcolor="#333333">&nbsp;<span style="color:#ffffff">&lt;%@Master Language=&quot;C#&quot; CodeFile=&quot;MasterPage.master.cs&quot; Inherits=&quot;MasterPage&quot; %&gt;</span></td>
</tr>
</tbody>
</table>
<br>
Master ディレクティブはこのページがマスタ ページであることを示し、マスタ ページに関する設定を行うことができます。 </li><li>さらに、本文中に ContentPlaceHolder コントロール (&lt;asp:ContentPlaceHolder&gt;) があることを確認することができます。<br>
<table cellpadding="5">
<tbody>
<tr>
<td bgcolor="#333333">&nbsp;<span style="color:#ffffff">&lt;asp:ContentPlaceHolder ID=&quot;ContentPlaceHolder1&quot; runat=&quot;server&quot;%&gt;</span></td>
</tr>
</tbody>
</table>
</li><li><br>
...
<span style="color:#ffffff">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;asp:Button1 ID=&quot;Button1&quot; runat=&quot;server&quot; Text=&quot;Button1&quot; /&gt;
<br>
&lt;/asp:Content&gt;</span></td>
</tr>
</tbody>
...
<br>
Content コントロールの中に、各 Web ページ固有のコンテンツを定義します。<br>
マスタ ページ上の予約域 (ContentPlaceHolder コントロール) との対応づけのために、Content コントロールの ContentPlaceHolderID に、マスタ ページの該当する ContentPlaceHolder コントロールの ID を指定します。<br>
特に ContentPlaceHolder コントロールを複数定義した場合には、この ID の対応づけが重要な意味を持ちます。 </li></ol>
</td>
</tr>
</tbody>
</table>
