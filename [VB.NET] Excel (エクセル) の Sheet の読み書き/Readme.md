...
<pre class="hidden"><code class="csharp">Imports Microsoft.Office.Interop.Excel
...
Module Module1
    ...
    End Sub
End Module</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Imports Microsoft.Office.Interop.Excel
