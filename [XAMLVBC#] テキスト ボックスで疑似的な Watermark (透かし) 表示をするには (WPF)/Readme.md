# [XAML/VB/C#] テキスト ボックスで疑似的な Watermark (透かし) 表示をするには (WPF)
## Requires
- 
## License
...
<p>動作確認環境: .Visual Studio 2008 SP1,.NET Framework 3.5 SP1</p>
<p>更新日: 2010 年 4 月 16 日</p>
<hr>
<h2>Code [XAML]</h2>
...
<pre class="hidden">&lt;Window x:Class=&quot;TextBox_WPF03_CS.Window1&quot;
    ...
    &lt;Grid&gt;
        ...
        &lt;!--TextBlockによるWatermark(透かし表示) [ZIndex指定なし]--&gt;
        &lt;TextBlock 
            Grid.Row=&quot;0&quot; Grid.Column=&quot;0&quot;
            HorizontalAlignment=&quot;Center&quot; 
            VerticalAlignment=&quot;Center&quot; 
            Foreground=&quot;Blue&quot;
            Text=&quot;透かし表示 ZIndex指定なし&quot; /&gt;
        &lt;TextBox 
            x:Name=&quot;textBlockWatermarkTextBox&quot; 
            Grid.Row=&quot;0&quot; Grid.Column=&quot;0&quot;
            Opacity=&quot;0.5&quot;
            TextChanged=&quot;textBlockWatermarkTextBox_TextChanged&quot;/&gt;

        &lt;!--TextBlockによるWatermark(透かし表示) [ZIndex指定あり]--&gt;
        &lt;TextBlock 
            Grid.Row=&quot;1&quot;
            Panel.ZIndex=&quot;0&quot; 
            HorizontalAlignment=&quot;Center&quot; 
            VerticalAlignment=&quot;Center&quot; 
            Foreground=&quot;Blue&quot;
            Text=&quot;透かし表示 ZIndex指定あり&quot; /&gt;
        &lt;TextBox 
            x:Name=&quot;textBlockWatermarkZIndexTextBox&quot; 
            Grid.Row=&quot;1&quot;
            Panel.ZIndex=&quot;1&quot; 
            Opacity=&quot;0.5&quot;
            TextChanged=&quot;textBlockWatermarkZIndexTextBox_TextChanged&quot;/&gt;

        &lt;!--イメージを利用したWatermark--&gt;
        &lt;TextBox 
            Grid.Row=&quot;2&quot;
            x:Name=&quot;imageWatermarkTextBox&quot; 
            TextChanged=&quot;imageWatermarkTextBox_TextChanged&quot;&gt;
            &lt;TextBox.Background&gt;
                &lt;ImageBrush ImageSource=&quot;WatermarkImage.jpg&quot; Stretch=&quot;None&quot; Opacity=&quot;0.5&quot;  /&gt;
            &lt;/TextBox.Background&gt;
        &lt;/TextBox&gt;
    &lt;/Grid&gt;
&lt;/Window&gt;</pre>
<pre class="xaml"><span class="xaml__tag_start">&lt;Window</span>&nbsp;x:<span class="xaml__attr_name">Class</span>=<span class="xaml__attr_value">&quot;TextBox_WPF03_CS.Window1&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">xmlns</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__keyword">xmlns</span>:<span class="xaml__attr_name">x</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Title</span>=<span class="xaml__attr_value">&quot;Window1&quot;</span>&nbsp;<span class="xaml__attr_name">Height</span>=<span class="xaml__attr_value">&quot;300&quot;</span>&nbsp;<span class="xaml__attr_name">Width</span>=<span class="xaml__attr_value">&quot;300&quot;</span><span class="xaml__tag_start">&gt;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Grid.RowDefinitions&gt;&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__comment">&lt;!--TextBlockによるWatermark(透かし表示)&nbsp;[ZIndex指定なし]--&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;TextBlock</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grid.<span class="xaml__attr_name">Row</span>=<span class="xaml__attr_value">&quot;0&quot;</span>&nbsp;Grid.<span class="xaml__attr_name">Column</span>=<span class="xaml__attr_value">&quot;0&quot;</span>&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Foreground</span>=<span class="xaml__attr_value">&quot;Blue&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Text</span>=<span class="xaml__attr_value">&quot;透かし表示&nbsp;ZIndex指定なし&quot;</span>&nbsp;<span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;TextBox</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x:<span class="xaml__attr_name">Name</span>=<span class="xaml__attr_value">&quot;textBlockWatermarkTextBox&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grid.<span class="xaml__attr_name">Row</span>=<span class="xaml__attr_value">&quot;0&quot;</span>&nbsp;Grid.<span class="xaml__attr_name">Column</span>=<span class="xaml__attr_value">&quot;0&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Opacity</span>=<span class="xaml__attr_value">&quot;0.5&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">TextChanged</span>=<span class="xaml__attr_value">&quot;textBlockWatermarkTextBox_TextChanged&quot;</span><span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__comment">&lt;!--TextBlockによるWatermark(透かし表示)&nbsp;[ZIndex指定あり]--&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;TextBlock</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grid.<span class="xaml__attr_name">Row</span>=<span class="xaml__attr_value">&quot;1&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Panel.<span class="xaml__attr_name">ZIndex</span>=<span class="xaml__attr_value">&quot;0&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">HorizontalAlignment</span>=<span class="xaml__attr_value">&quot;Center&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">VerticalAlignment</span>=<span class="xaml__attr_value">&quot;Center&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Foreground</span>=<span class="xaml__attr_value">&quot;Blue&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Text</span>=<span class="xaml__attr_value">&quot;透かし表示&nbsp;ZIndex指定あり&quot;</span>&nbsp;<span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;TextBox</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x:<span class="xaml__attr_name">Name</span>=<span class="xaml__attr_value">&quot;textBlockWatermarkZIndexTextBox&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grid.<span class="xaml__attr_name">Row</span>=<span class="xaml__attr_value">&quot;1&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Panel.<span class="xaml__attr_name">ZIndex</span>=<span class="xaml__attr_value">&quot;1&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Opacity</span>=<span class="xaml__attr_value">&quot;0.5&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">TextChanged</span>=<span class="xaml__attr_value">&quot;textBlockWatermarkZIndexTextBox_TextChanged&quot;</span><span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__comment">&lt;!--イメージを利用したWatermark--&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;TextBox</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grid.<span class="xaml__attr_name">Row</span>=<span class="xaml__attr_value">&quot;2&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x:<span class="xaml__attr_name">Name</span>=<span class="xaml__attr_value">&quot;imageWatermarkTextBox&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">TextChanged</span>=<span class="xaml__attr_value">&quot;imageWatermarkTextBox_TextChanged&quot;</span><span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;TextBox</span>.Background<span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;ImageBrush</span>&nbsp;<span class="xaml__attr_name">ImageSource</span>=<span class="xaml__attr_value">&quot;WatermarkImage.jpg&quot;</span>&nbsp;<span class="xaml__attr_name">Stretch</span>=<span class="xaml__attr_value">&quot;None&quot;</span>&nbsp;<span class="xaml__attr_name">Opacity</span>=<span class="xaml__attr_value">&quot;0.5&quot;</span>&nbsp;&nbsp;<span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/TextBox.Background&gt;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_end">&lt;/TextBox&gt;</span>&nbsp;
...
<pre class="hidden">//TextBlockによるWatermark(透かし表示) ZIndex指定なし
private void textBlockWatermarkTextBox_TextChanged(object sender, TextChangedEventArgs e)
{
    TextBox targetTextBox = (TextBox)sender;

    if (targetTextBox.Text == &quot;&quot;)
    {
        targetTextBox.Opacity = 0.5;
    }
    else
    {
        targetTextBox.Opacity = 1.0;
    }
}

//TextBlockによるWatermark(透かし表示) ZIndex指定あり
private void textBlockWatermarkZIndexTextBox_TextChanged(object sender, TextChangedEventArgs e)
{
    TextBox targetTextBox = (TextBox)sender;
...
//イメージを利用したWatermark(透かし表示)
private void imageWatermarkTextBox_TextChanged(object sender, TextChangedEventArgs e)
{
    TextBox targetTextBox = (TextBox)sender;

    if (targetTextBox.Text == &quot;&quot;)
    {
        ImageBrush watermarkBrush = new ImageBrush();
        watermarkBrush.ImageSource = 
            new BitmapImage(new Uri(@&quot;WatermarkImage.jpg&quot;, UriKind.Relative));
        watermarkBrush.Stretch = Stretch.None;
        watermarkBrush.Opacity = 0.5;
        targetTextBox.Background = watermarkBrush;
    }
    else
    {
        targetTextBox.Background = null;
    }
}</pre>
<pre class="vb">//TextBlockによるWatermark(透かし表示)&nbsp;ZIndex指定なし&nbsp;
private&nbsp;void&nbsp;textBlockWatermarkTextBox_TextChanged(object&nbsp;sender,&nbsp;TextChangedEventArgs&nbsp;e)&nbsp;
{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;TextBox&nbsp;targetTextBox&nbsp;=&nbsp;(TextBox)sender;&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(targetTextBox.Text&nbsp;==&nbsp;<span class="visualBasic__string">&quot;&quot;</span>)&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;targetTextBox.Opacity&nbsp;=&nbsp;<span class="visualBasic__number">0.5</span>;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;else&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;targetTextBox.Opacity&nbsp;=&nbsp;<span class="visualBasic__number">1.0</span>;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;
}&nbsp;
&nbsp;
//TextBlockによるWatermark(透かし表示)&nbsp;ZIndex指定あり&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ImageBrush&nbsp;watermarkBrush&nbsp;=&nbsp;new&nbsp;ImageBrush();&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;watermarkBrush.ImageSource&nbsp;=&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;new&nbsp;BitmapImage(new&nbsp;Uri(@<span class="visualBasic__string">&quot;WatermarkImage.jpg&quot;</span>,&nbsp;UriKind.Relative));&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;watermarkBrush.Stretch&nbsp;=&nbsp;Stretch.None;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;watermarkBrush.Opacity&nbsp;=&nbsp;<span class="visualBasic__number">0.5</span>;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;targetTextBox.Background&nbsp;=&nbsp;watermarkBrush;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;else&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;{&nbsp;
...
<pre class="hidden">'TextBlockによるWatermark(透かし表示) ZIndex指定なし
Private Sub textBlockWatermarkTextBox_TextChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.TextChangedEventArgs)
    Dim targetTextBox As TextBox = CType(sender, TextBox)
...
'TextBlockによるWatermark(透かし表示) ZIndex指定あり
Private Sub textBlockWatermarkZIndexTextBox_TextChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.TextChangedEventArgs)
    Dim targetTextBox As TextBox = CType(sender, TextBox)
...
'イメージを利用したWatermark(透かし表示)
Private Sub imageWatermarkTextBox_TextChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.TextChangedEventArgs)
    Dim targetTextBox As TextBox = CType(sender, TextBox)

    If targetTextBox.Text = &quot;&quot; Then
        Dim watermarkBrush As New ImageBrush
        watermarkBrush.ImageSource = _
                New BitmapImage( _
                    New Uri(&quot;WatermarkImage.jpg&quot;, UriKind.Relative))

        watermarkBrush.Stretch = Stretch.None
        watermarkBrush.Opacity = 0.5
        targetTextBox.Background = watermarkBrush
    Else
        targetTextBox.Background = Nothing
    End If
End Sub</pre>
<pre class="vb"><span class="visualBasic__com">'TextBlockによるWatermark(透かし表示)&nbsp;ZIndex指定なし</span>&nbsp;
<span class="visualBasic__keyword">Private</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;textBlockWatermarkTextBox_TextChanged(<span class="visualBasic__keyword">ByVal</span>&nbsp;sender&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;System.<span class="visualBasic__keyword">Object</span>,&nbsp;<span class="visualBasic__keyword">ByVal</span>&nbsp;e&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;System.Windows.Controls.TextChangedEventArgs)&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Dim</span>&nbsp;targetTextBox&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;TextBox&nbsp;=&nbsp;<span class="visualBasic__keyword">CType</span>(sender,&nbsp;TextBox)&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">If</span>&nbsp;targetTextBox.Text&nbsp;=&nbsp;<span class="visualBasic__string">&quot;&quot;</span>&nbsp;<span class="visualBasic__keyword">Then</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;targetTextBox.Opacity&nbsp;=&nbsp;<span class="visualBasic__number">0.5</span>&nbsp;
...
&nbsp;
<span class="visualBasic__com">'TextBlockによるWatermark(透かし表示)&nbsp;ZIndex指定あり</span>&nbsp;
<span class="visualBasic__keyword">Private</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;textBlockWatermarkZIndexTextBox_TextChanged(<span class="visualBasic__keyword">ByVal</span>&nbsp;sender&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;System.<span class="visualBasic__keyword">Object</span>,&nbsp;<span class="visualBasic__keyword">ByVal</span>&nbsp;e&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;System.Windows.Controls.TextChangedEventArgs)&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Dim</span>&nbsp;targetTextBox&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;TextBox&nbsp;=&nbsp;<span class="visualBasic__keyword">CType</span>(sender,&nbsp;TextBox)&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">If</span>&nbsp;targetTextBox.Text&nbsp;=&nbsp;<span class="visualBasic__string">&quot;&quot;</span>&nbsp;<span class="visualBasic__keyword">Then</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;targetTextBox.Opacity&nbsp;=&nbsp;<span class="visualBasic__number">0.5</span>&nbsp;
...
<span class="visualBasic__keyword">End</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;
&nbsp;
<span class="visualBasic__com">'イメージを利用したWatermark(透かし表示)</span>&nbsp;
<span class="visualBasic__keyword">Private</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;imageWatermarkTextBox_TextChanged(<span class="visualBasic__keyword">ByVal</span>&nbsp;sender&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;System.<span class="visualBasic__keyword">Object</span>,&nbsp;<span class="visualBasic__keyword">ByVal</span>&nbsp;e&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;System.Windows.Controls.TextChangedEventArgs)&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Dim</span>&nbsp;targetTextBox&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;TextBox&nbsp;=&nbsp;<span class="visualBasic__keyword">CType</span>(sender,&nbsp;TextBox)&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">If</span>&nbsp;targetTextBox.Text&nbsp;=&nbsp;<span class="visualBasic__string">&quot;&quot;</span>&nbsp;<span class="visualBasic__keyword">Then</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Dim</span>&nbsp;watermarkBrush&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;<span class="visualBasic__keyword">New</span>&nbsp;ImageBrush&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;watermarkBrush.ImageSource&nbsp;=&nbsp;_&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">New</span>&nbsp;BitmapImage(&nbsp;_&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">New</span>&nbsp;Uri(<span class="visualBasic__string">&quot;WatermarkImage.jpg&quot;</span>,&nbsp;UriKind.Relative))&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;watermarkBrush.Stretch&nbsp;=&nbsp;Stretch.None&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;watermarkBrush.Opacity&nbsp;=&nbsp;<span class="visualBasic__number">0.5</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;targetTextBox.Background&nbsp;=&nbsp;watermarkBrush&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Else</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;targetTextBox.Background&nbsp;=&nbsp;<span class="visualBasic__keyword">Nothing</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">End</span>&nbsp;<span class="visualBasic__keyword">If</span>&nbsp;
<span class="visualBasic__keyword">End</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;
&nbsp;
</pre>
...
<h2>実行結果</h2>
<p>データ未入力状態 (透かし表示)</p>
<p><img src="15549-image.png" alt=""></p>
<p>データ入力済状態</p>
<p><img src="15550-image.png" alt=""></p>
<h2>ポイント</h2>
<p>データ入力を行う際に、各テキスト ボックスに項目名や入力例などを透かし表示したい場合、いろいろな方法で実現できますが、ここではコードを利用した 3 つの方法について解説したいと思います。</p>
<p>1 つ目は、&#26684;子のレイアウトを行うためのコントロール Grid の特性を利用したものになります。</p>
<p>Grid では通常、コントロールを&#26684;子のどの列・行に配置するかを Row プロパティ, Column プロパティといった添付プロパティによって配置を制御します。</p>
<p>Row プロパティ、Column プロパティはその中のコントロールの宣言順序に依存せず指定の位置にコントロールを配置することができますが、Row および Column の値が同一のコントロールが複数存在する場合は、コントロールが宣言された順にコントロールの描画が行われるため、後で宣言されたコントロールのほうが前面に描画されます。</p>
<p>その特性を利用し、以下の手順でコントロールを配置します。</p>
<ol>
<li>Grid コントロール上のセル Row=0, Column=0 へ、透かし表示を行いたいテキストを表示した TextBlock を配置 </li><li>次に同じ位置 (Row=0, Column=0) へ TextBox を配置 (このとき、TextBox 要素は TextBlock 要素より後方に記述)
</li><li>コントロールの Opacity プロパティ (不透過率) を 0.5 に設定 </li><li>TextChanged イベントによりテキストが入力済かどうかを判定し、テキストの入力が空欄であれば Opacity を 0.5、空欄でなければ Opacity プロパティを 1 に設定
</li></ol>
<p>上記の方法で疑&#20284;的な Watermark を実現しています。</p>
<p>2 つめは 1 つめの方法に加えて Panel.ZIndex プロパティを使って疑&#20284;的に前後関係を指定しています。</p>
<p>そのため、1 つめの方法のようにコントロールの宣言順序に依存することなくコントロールの前後関係を設定することができます。</p>
<p>最後は TextBox の Background プロパティに指定する方法についても合わせてご紹介します。</p>
<p>Background プロパティは Brush 型のオブジェクトを指定できるので、Brush 型で表示できるようなオブジェクトであれば Watermark として利用することができます。</p>
<p>サンプルでは ImageBrush を利用し、指定された JPEG 画像を Watermark として利用しています。</p>
<p>あらかじめ、Watermark として利用するイメージを XAML 上でセットしておき、先ほどの方法と同様、TextChanged イベントで空欄かどうかの判定を行い、背景となる ImageBrush の設定・クリアを切り替えることで画像を利用した Watermark を実現しています。</p>
