...
<p>例えば、以下では、名前に「System.String」の文字列を含む型を列挙します。</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<p>実行結果:</p>
<p>System.String<br>
System.StringSplitOptions<br>
System.StringComparer<br>
System.StringComparison<br>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">dynamic instance = Activator.CreateInstance(t);
