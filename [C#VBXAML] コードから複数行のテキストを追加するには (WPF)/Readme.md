# [C#/VB/XAML] コードから複数行のテキストを追加するには (WPF)
## Requires
- 
## License
...
<p>動作確認環境: .NET Framework 3.5, Visual Studio 2008</p>
...
<pre class="hidden">&lt;UserControl x:Class=&quot;TextBlock_SL05.MainPage&quot;
    ...
    &lt;StackPanel x:Name=&quot;LayoutRoot&quot;&gt;
        &lt;TextBlock x:Name=&quot;textBlock1&quot; FontSize=&quot;40&quot;/&gt;
        &lt;TextBlock x:Name=&quot;textBlock2&quot; FontSize=&quot;40&quot; /&gt;
    &lt;/StackPanel&gt;
&lt;/UserControl&gt;</pre>
<pre class="xaml"><span class="xaml__tag_start">&lt;UserControl</span>&nbsp;x:<span class="xaml__attr_name">Class</span>=<span class="xaml__attr_value">&quot;TextBlock_SL05.MainPage&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">xmlns</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__keyword">xmlns</span>:<span class="xaml__attr_name">x</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__keyword">xmlns</span>:<span class="xaml__attr_name">d</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/expression/blend/2008&quot;</span>&nbsp;<span class="xaml__keyword">xmlns</span>:<span class="xaml__attr_name">mc</span>=<span class="xaml__attr_value">&quot;http://schemas.openxmlformats.org/markup-compatibility/2006&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;mc:<span class="xaml__attr_name">Ignorable</span>=<span class="xaml__attr_value">&quot;d&quot;</span>&nbsp;d:<span class="xaml__attr_name">DesignWidth</span>=<span class="xaml__attr_value">&quot;640&quot;</span>&nbsp;d:<span class="xaml__attr_name">DesignHeight</span>=<span class="xaml__attr_value">&quot;480&quot;</span>&nbsp;<span class="xaml__attr_name">Loaded</span>=<span class="xaml__attr_value">&quot;UserControl_Loaded&quot;</span><span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;StackPanel</span>&nbsp;x:<span class="xaml__attr_name">Name</span>=<span class="xaml__attr_value">&quot;LayoutRoot&quot;</span><span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;TextBlock</span>&nbsp;x:<span class="xaml__attr_name">Name</span>=<span class="xaml__attr_value">&quot;textBlock1&quot;</span>&nbsp;<span class="xaml__attr_name">FontSize</span>=<span class="xaml__attr_value">&quot;40&quot;</span><span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;TextBlock</span>&nbsp;x:<span class="xaml__attr_name">Name</span>=<span class="xaml__attr_value">&quot;textBlock2&quot;</span>&nbsp;<span class="xaml__attr_name">FontSize</span>=<span class="xaml__attr_value">&quot;40&quot;</span>&nbsp;<span class="xaml__tag_start">/&gt;</span>&nbsp;
...
<pre class="hidden"><code class="csharp">'通常のテキストを指定
textBlock1.Text = &quot;abc&quot;

'複数書式を指定する
Dim r1 As New Run() With {.Text = &quot;Line1&quot;, .FontSize = 20}
Dim r2 As New Run() With {.Text = &quot;Line2&quot;, .FontSize = 30}

textBlock2.Inlines.Add(r1)
'改行の指定
textBlock2.Inlines.Add(New LineBreak())
textBlock2.Inlines.Add(r2)

'現在テキストへ挿入
Dim r0 As New Run() With {.Text = &quot;Line0&quot;, .FontSize = 15}

'Insert(挿入したい行のInlineオブジェクト, 挿入するRunやLineBreak)
textBlock2.Inlines.InsertBefore(textBlock2.Inlines.FirstInline, r0)
textBlock2.Inlines.InsertAfter(textBlock2.Inlines.FirstInline, New LineBreak())</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">'通常のテキストを指定
textBlock1.Text = &quot;abc&quot;
...
<pre class="hidden">//通常のテキストを指定
textBlock1.Text = &quot;abc&quot;;

//複数書式を指定する
var r1 = new Run() { Text = &quot;Line1&quot;, FontSize = 20 };
var r2 = new Run() { Text = &quot;Line2&quot;, FontSize = 30 };
...
//現在テキストへ挿入
var r0 = new Run() { Text = &quot;Line0&quot;, FontSize = 15 };

//Insert(挿入したい行のInlineオブジェクト, 挿入するRunやLineBreak)
textBlock2.Inlines.InsertBefore(textBlock2.Inlines.FirstInline, r0);
textBlock2.Inlines.InsertAfter(textBlock2.Inlines.FirstInline, new LineBreak());</pre>
<pre class="csharp"><span class="cs__com">//通常のテキストを指定</span>&nbsp;
textBlock1.Text&nbsp;=&nbsp;<span class="cs__string">&quot;abc&quot;</span>;&nbsp;
&nbsp;
<span class="cs__com">//複数書式を指定する</span>&nbsp;
var&nbsp;r1&nbsp;=&nbsp;<span class="cs__keyword">new</span>&nbsp;Run()&nbsp;{&nbsp;Text&nbsp;=&nbsp;<span class="cs__string">&quot;Line1&quot;</span>,&nbsp;FontSize&nbsp;=&nbsp;<span class="cs__number">20</span>&nbsp;};&nbsp;
var&nbsp;r2&nbsp;=&nbsp;<span class="cs__keyword">new</span>&nbsp;Run()&nbsp;{&nbsp;Text&nbsp;=&nbsp;<span class="cs__string">&quot;Line2&quot;</span>,&nbsp;FontSize&nbsp;=&nbsp;<span class="cs__number">30</span>&nbsp;};&nbsp;
&nbsp;
textBlock2.Inlines.Add(r1);&nbsp;
<span class="cs__com">//改行の指定</span>&nbsp;
textBlock2.Inlines.Add(<span class="cs__keyword">new</span>&nbsp;LineBreak());&nbsp;
textBlock2.Inlines.Add(r2);&nbsp;
&nbsp;
<span class="cs__com">//現在テキストへ挿入</span>&nbsp;
var&nbsp;r0&nbsp;=&nbsp;<span class="cs__keyword">new</span>&nbsp;Run()&nbsp;{&nbsp;Text&nbsp;=&nbsp;<span class="cs__string">&quot;Line0&quot;</span>,&nbsp;FontSize&nbsp;=&nbsp;<span class="cs__number">15</span>&nbsp;};&nbsp;
&nbsp;
<span class="cs__com">//Insert(挿入したい行のInlineオブジェクト,&nbsp;挿入するRunやLineBreak)</span>&nbsp;
textBlock2.Inlines.InsertBefore(textBlock2.Inlines.FirstInline,&nbsp;r0);&nbsp;
textBlock2.Inlines.InsertAfter(textBlock2.Inlines.FirstInline,&nbsp;<span class="cs__keyword">new</span>&nbsp;LineBreak());&nbsp;
&nbsp;
</pre>
</div>
</div>
...
<h2>実行結果</h2>
<p><img src="15263-image.png" alt=""></p>
<h2>ポイント</h2>
<p>TextBlock は軽量のフロー コンテンツを表示するために利用されるコントロールです。フロー コンテンツとは特定のレイアウトに依存せず、中に設定されるテキスト・画像などの各オブジェクトを臨機応変に配置できるコンテンツです。</p>
<p>その中でも TextBlock は数行のテキストを表示するために最適化されています。</p>
<p>そのため、簡単なテキストを表示するだけであれば Text プロパティに文字列を指定するだけで表示できます。</p>
<p>数行であれば Inlines プロパティへ Inline オブジェクト (テキストをブロック化する Run や Bold, HyperLink, Italic, LineBreak, Span, Underline など) を複数設定することで表示できます。</p>
<p>Inlines プロパティは Inline オブジェクトを複数取り扱うことができるコレクション クラスになっているため、臨機応変に InlineObject を追加・削除・挿入等が行えるようなメソッドが用意されています。</p>
<h2>参考</h2>
<p>TextBlock コンテンツ モデルの概要<br>
<a href="http://msdn.microsoft.com/ja-jp/library/bb613554.aspx">http://msdn.microsoft.com/ja-jp/library/bb613554.aspx</a></p>
