# [XAML/C#/VB] データ グリッド (DataGrid) をコントロール全体・列単位で読み取り専用にする方法 (WPF)
## Requires
- 
## License
...
<p>今回は <a href="http://msdn.microsoft.com/ja-jp/library/system.windows.controls.datagrid.isreadonly.aspx">
DataGrid.IsReadOnly</a> プロパティを用いてコントロール全体を読み取りのみにする方法、<a href="http://msdn.microsoft.com/ja-jp/library/system.windows.controls.datagridcolumn.isreadonly.aspx">DataGridColumn.IsReadOnly</a> プロパティを用いて列単位で読み取りのみにする方法をご紹介します。</p>
<h2>[XAML] DataGrid コントロール全体を編集不可能 (読み取りのみ) にする方法 (MainWindow.xaml)</h2>
...
<pre class="hidden">&lt;Window x:Class=&quot;DataGrid_WPF03_1.MainWindow&quot;
        xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
        xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
        xmlns:local=&quot;clr-namespace:DataGrid_WPF03_1&quot;
    ...
    &lt;/Window.Resources&gt;
    &lt;Grid&gt;
        &lt;!--編集をできなくするにはIsReadOnlyプロパティをTrueにする--&gt;
        &lt;DataGrid
            Grid.Row=&quot;0&quot;
            Margin=&quot;5&quot;
    ...
    &lt;/Grid&gt;
&lt;/Window&gt;</pre>
<pre class="xaml"><span class="xaml__tag_start">&lt;Window</span>&nbsp;x:<span class="xaml__attr_name">Class</span>=<span class="xaml__attr_value">&quot;DataGrid_WPF03_1.MainWindow&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">xmlns</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__keyword">xmlns</span>:<span class="xaml__attr_name">x</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__keyword">xmlns</span>:<span class="xaml__attr_name">local</span>=<span class="xaml__attr_value">&quot;clr-namespace:DataGrid_WPF03_1&quot;</span>&nbsp;
...
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__comment">&lt;!--編集をできなくするにはIsReadOnlyプロパティをTrueにする--&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;DataGrid</span>&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">IsReadOnly</span>=<span class="xaml__attr_value">&quot;True&quot;</span><span class="xaml__tag_start">/&gt;</span>&nbsp;
...
<p><br>
これらの表示に必要となるエンティティ クラスを C#、VB の双方で用意しています。お使いの言語に合わせて選択してください。</p>
<p>&nbsp;</p>
<h2>[C#] エンティティ クラス (Book.cs)</h2>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
&nbsp;&nbsp;
<span class="cs__keyword">namespace</span>&nbsp;DataGrid_WPF03_1&nbsp;
{&nbsp;
&nbsp;&nbsp;
...
<h2>[VB] コード ビハインドおよびエンティティ クラス (MainWindow.vb)</h2>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<h2>実行結果</h2>
<p>実行結果は以下のようになります。IsReadOnly プロパティは編集モードに移行を制御するプロパティです。通常、特に設定のない状態ではデータグリッド上のセルをクリックすると編集モードに移行しますが、IsReadOnly = True とすることで編集モードに移行しなくなります。つまり、見た目では編集可能な状態と変わらないため IsReadOnly が True であるかどうかは判定できません。</p>
<p><img src="15590-image.png" alt=""></p>
<p>次に、特定の列のみ編集不可能 (読み取り専用) にする方法をご紹介します。</p>
<p>&nbsp;</p>
<h3>[XAML] DataGrid コントロールの特定の列を編集不可能 (読み取りのみ) にする方法 (MainPage.xaml)</h3>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<span class="hidden">xaml</span>
<pre class="hidden"><code class="csharp">&lt;Window x:Class=&quot;DataGrid_WPF03_2.MainWindow&quot;
        xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
        xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
        xmlns:local=&quot;clr-namespace:DataGrid_WPF03_2&quot;
        Title=&quot;MainWindow&quot; Height=&quot;350&quot; Width=&quot;525&quot;&gt;
    &lt;Window.Resources&gt;
        &lt;x:Array x:Key=&quot;BookData&quot; Type=&quot;local:Book&quot;&gt;
            &lt;local:Book 
    ...
    &lt;Grid&gt;
        ...
        &lt;!--列単位で編集可・不可を調整するにはDataGrid.Columnsに定義した
            DataGridColumnオブジェクトのIsReadOnlyプロパティを設定する--&gt;
        &lt;DataGrid 
            ItemsSource=&quot;{StaticResource BookData}&quot;
            ...
            &lt;DataGrid.Columns&gt;
                &lt;DataGridTextColumn 
                    IsReadOnly=&quot;True&quot;
                    Header=&quot;書籍名(IsReadOnly=True)&quot;
                    Binding=&quot;{Binding BookName}&quot; /&gt;
 
                &lt;DataGridTextColumn 
                    IsReadOnly=&quot;False&quot;
                    Header=&quot;書籍名(IsReadOnly=False)&quot;
                    Binding=&quot;{Binding BookName}&quot; /&gt;
            &lt;/DataGrid.Columns&gt;
        &lt;/DataGrid&gt;
    ...
    &lt;/Grid&gt;
&lt;/Window&gt;</code></pre>
<pre id="codePreview" class="xaml"><code class="csharp">&lt;Window x:Class=&quot;DataGrid_WPF03_2.MainWindow&quot;
        xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
        xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
        xmlns:local=&quot;clr-namespace:DataGrid_WPF03_2&quot;
        Title=&quot;MainWindow&quot; Height=&quot;350&quot; Width=&quot;525&quot;&gt;
...
<p>コード ビハインドは C# における名前空間を DataGrid_WPF03_01 から DataGrid_WPF03_02 に変える以外は前述のものと同じ内容になります。</p>
<p>この実行結果は以下のようになります。IsReadOnly プロパティが False の列は編集可能になっています。</p>
<p><img src="15591-image.png" alt=""></p>
<p>このように、IsReadOnly プロパティを用いることで、DataGrid コントロール全体、または列 (DataGridColumn) 単位でセルを編集不可能 (読み取りのみ) に設定することができます。</p>
<p>また、<a href="http://msdn.microsoft.com/ja-jp/library/system.windows.uielement.isenabled.aspx">DataGrid.IsEnabled</a> プロパティを False に設定することで、DataGrid コントロール全体を無効化することもできますが、IsReadOnly と異なり全体が薄い色で表示されます。</p>
<p>そして、選択を行うことができない、Click などのヒット テストに依存するイベントが発生しないといった動作になります。参考までに DataGrid.IsEnabled を False に設定した図を以下に示します。</p>
<p><img src="15592-image.png" alt=""></p>
