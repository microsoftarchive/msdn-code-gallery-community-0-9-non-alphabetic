...
<hr>
<p>System.Diagnostics.EventLog クラスを利用することでソフトウェア イベント、ハードウェア イベントについての情報を記録する Windows イベント ログにアクセスすることができます。ログを読み取る場合は EventLog.GetEventLogs() メソッドですべてのイベントログを取得するか、EventLog インスタンスを作成し、
