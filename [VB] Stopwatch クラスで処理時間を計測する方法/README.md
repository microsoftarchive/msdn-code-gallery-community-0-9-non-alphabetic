...
<hr>
<p><a href="http://msdn.microsoft.com/ja-jp/library/system.diagnostics.stopwatch(VS.80).aspx">System.Diagnostics.Stopwatch</a> は .NET Framework 2.0 から追加された、経過時間を正確に計測するために使用できるメソッドとプロパティのセットを提供するクラスです。計測を開始するには
<a href="http://msdn.microsoft.com/ja-jp/library/system.diagnostics.stopwatch.start(VS.80).aspx">
Start</a> メソッド、終了するには <a href="http://msdn.microsoft.com/ja-jp/library/system.diagnostics.stopwatch.stop(VS.80).aspx">
Stop</a> メソッドを使用します。ある処理の計測を行ったサンプル コードは下記のようになります。</p>
...
<p>計測を開始します。<br>
計測を完了しました<br>
経過時間の合計 = 00:00:03.0052560<br>
ミリ秒単位の経過時間の合計 = 3005<br>
経過時間の分解能 (1 秒あたり) = 2078183</p>
</div>
<p><br>
経過時間は <a href="http://msdn.microsoft.com/ja-jp/library/system.diagnostics.stopwatch.elapsed(VS.80).aspx">
Elapsed</a>、<a href="http://msdn.microsoft.com/ja-jp/library/system.diagnostics.stopwatch.elapsedmilliseconds(VS.80).aspx">ElapsedMilliseconds</a>、<a href="http://msdn.microsoft.com/ja-jp/library/system.diagnostics.stopwatch.elapsedticks(VS.80).aspx">ElapsedTicks</a>
 でそれぞれ取得することができます。ElapsedTicks は内部で利用しているタイマーのカウント数です。このタイマーの 1 秒あたりの分解能は Stopwatch.Frequency で求めることが可能です。また、Stopwatch が高分解能のタイマーに基づいているかを確認するためには
<a href="http://msdn.microsoft.com/ja-jp/library/system.diagnostics.stopwatch.ishighresolution(VS.80).aspx">
Stopwatch.IsHighResolution</a> フィールドを確認します。</p>
<h3>関連リンク</h3>
<ul>
<li><a href="http://msdn.microsoft.com/ja-jp/library/system.diagnostics.stopwatch(VS.80).aspx">Stopwatch クラス</a>
</li></ul>
