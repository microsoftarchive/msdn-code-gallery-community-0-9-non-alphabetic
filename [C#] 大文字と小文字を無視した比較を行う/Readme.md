...
<div id="top">
<p>動作確認環境: .NET Framework 1.1, Visual Studio 2003</p>
<p>更新日: 2010 年 2 月 12 日</p>
<hr>
<p>文字列の比較において、大文字 (&quot;ABC&quot;) と小文字 (&quot;abc&quot;) の区別を無視した比較を行いたい場合がありますが、そのような時に便利なのが <a href="http://msdn.microsoft.com/ja-jp/library/system.string.compare.aspx">
String.Compare (String, String, bool ignoreCase) 関数</a> です。</p>
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine(&quot;大文字小文字を無視した比較&quot;);
        result = String.Compare(&quot;ABC&quot;, &quot;abc&quot;, true);
        Console.WriteLine(&quot;ABC : abc の比較結果 = {0}&quot;, result);

        Console.WriteLine(&quot;通常の比較&quot;);
        result = String.Compare(&quot;ABC&quot;, &quot;abc&quot;);
        Console.WriteLine(&quot;ABC : abc の比較結果 = {0}&quot;, result);
    }
}</code></pre>
...
<p>&quot;ABC&quot; と &quot;abc&quot; の比較結果が 0 (等しい) となっていることがおわかりいただけると思います。</p>
<p>さらに詳しい利用方法については MSDN ライブラリの</p>
<ul>
<li><strong>String.Compare メソッド (System)</strong><br>
<a href="http://msdn.microsoft.com/ja-jp/library/system.string.compare.aspx">http://msdn.microsoft.com/ja-jp/library/system.string.compare.aspx</a>
</li><li><strong>StringComparer クラス (System)</strong><br>
<a href="http://msdn.microsoft.com/ja-jp/library/system.stringcomparer.aspx">http://msdn.microsoft.com/ja-jp/library/system.stringcomparer.aspx</a>
</li></ul>
<p>をご参照ください。</p>
