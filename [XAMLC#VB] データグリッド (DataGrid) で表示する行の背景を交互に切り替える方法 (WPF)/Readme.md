# [XAML/C#/VB] データグリッド (DataGrid) で表示する行の背景を交互に切り替える方法 (WPF)
## Requires
- 
## License
...
<p>動作確認環境: Visual Studio 2010、Windows 7 Enterprise</p>
<p>更新日: 2010 年 7 月 2 日</p>
<p>WPF の <a href="http://msdn.microsoft.com/ja-jp/library/system.windows.controls.datagrid.aspx">
DataGrid</a> コントロールでは、データのコレクションを表示するための柔軟な機能が用意されています。</p>
<p>DataGrid コントロールでは行の背景色を交互に異なる色を設定することが可能です。</p>
<p>DataGrid コントロールでは全体の背景を指定する <a href="http://msdn.microsoft.com/ja-jp/library/system.windows.controls.control.background.aspx">
Background</a> プロパティに薄い黄色 (LightYellow)、行の背景に用いられる <a href="http://msdn.microsoft.com/ja-jp/library/system.windows.controls.datagrid.rowbackground.aspx">
RowBackground</a> プロパティには薄い青 (LightBlue)、交互に表示される行の背景には <a href="http://msdn.microsoft.com/ja-jp/library/system.windows.controls.datagrid.alternatingrowbackground.aspx">
AlternatingRowBackground</a> プロパティに空色 (Azure) を設定しています。</p>
<hr>
<h2>Code [XAML] : DataGrid コントロールで交互に背景色を切り替える方法&nbsp;(MainWindow.xaml)</h2>
...
<pre class="hidden">&lt;Window x:Class=&quot;DataGrid_WPF05.MainWindow&quot;
        xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
        xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
        xmlns:entity=&quot;clr-namespace:DataGrid_WPF05&quot;
        Title=&quot;MainWindow&quot; Height=&quot;350&quot; Width=&quot;525&quot;&gt;
    &lt;Window.Resources&gt;
        &lt;x:Array x:Key=&quot;BookData&quot; Type=&quot;entity:Book&quot;&gt;
            &lt;entity:Book 
                BookName=&quot;週刊マイクロソフト&quot; 
                InStock=&quot;True&quot; 
                Location=&quot;新宿&quot; 
    ...
    &lt;/Grid&gt;
&lt;/Window&gt;</pre>
<pre class="xaml"><span class="xaml__tag_start">&lt;Window</span>&nbsp;x:<span class="xaml__attr_name">Class</span>=<span class="xaml__attr_value">&quot;DataGrid_WPF05.MainWindow&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">xmlns</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__keyword">xmlns</span>:<span class="xaml__attr_name">x</span>=<span class="xaml__attr_value">&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__keyword">xmlns</span>:<span class="xaml__attr_name">entity</span>=<span class="xaml__attr_value">&quot;clr-namespace:DataGrid_WPF05&quot;</span>&nbsp;
...
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;x</span>:Array&nbsp;x:<span class="xaml__attr_name">Key</span>=<span class="xaml__attr_value">&quot;BookData&quot;</span>&nbsp;<span class="xaml__attr_name">Type</span>=<span class="xaml__attr_value">&quot;entity:Book&quot;</span><span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;entity</span>:Book&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">BookName</span>=<span class="xaml__attr_value">&quot;週刊マイクロソフト&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">InStock</span>=<span class="xaml__attr_value">&quot;True&quot;</span>&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;entity</span>:Book&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">BookName</span>=<span class="xaml__attr_value">&quot;はじめてのＭＳ&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">InStock</span>=<span class="xaml__attr_value">&quot;False&quot;</span>&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">BookInfo</span>=<span class="xaml__attr_value">&quot;http://www.microsoft.com&quot;</span>&nbsp;<span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;entity</span>:Book&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">BookName</span>=<span class="xaml__attr_value">&quot;LIFE&nbsp;RUNS&nbsp;ON&nbsp;CODE&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">InStock</span>=<span class="xaml__attr_value">&quot;False&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Location</span>=<span class="xaml__attr_value">&quot;赤坂&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">BookInfo</span>=<span class="xaml__attr_value">&quot;http://www.microsoft.com&quot;</span>&nbsp;<span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_end">&lt;/x:Array&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Window.Resources&gt;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;Grid</span><span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;DataGrid</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">ItemsSource</span>=<span class="xaml__attr_value">&quot;{StaticResource&nbsp;BookData}&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Background</span>=<span class="xaml__attr_value">&quot;LightYellow&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">RowBackground</span>=<span class="xaml__attr_value">&quot;LightBlue&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">AlternatingRowBackground</span>=<span class="xaml__attr_value">&quot;Azure&quot;</span>&nbsp;<span class="xaml__tag_start">/&gt;</span>&nbsp;
...
<p>表示データに利用するエンティティ クラスの定義を C#、Visual Basic の双方で用意しています。お使いの言語に合わせて選択してください。</p>
<h2>Code [C#] : エンティティ クラスの定義 (Book.cs)</h2>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
&nbsp;
<span class="cs__keyword">namespace</span>&nbsp;DataGrid_WPF05&nbsp;
{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">///&nbsp;&lt;summary&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">///&nbsp;店舗リスト</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">///&nbsp;&lt;/summary&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__keyword">public</span>&nbsp;<span class="cs__keyword">enum</span>&nbsp;ShopList&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新宿,&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;初台,&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大手町,&nbsp;
...
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">///&nbsp;&lt;summary&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">///&nbsp;エンティティクラス(書籍情報)</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">///&nbsp;&lt;/summary&gt;</span>&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__keyword">public</span>&nbsp;ShopList&nbsp;Location&nbsp;&nbsp;&nbsp;&nbsp;{&nbsp;<span class="cs__keyword">get</span>;&nbsp;<span class="cs__keyword">set</span>;&nbsp;}&nbsp;
...
<h2>Code [VB] : エンティティ クラスの定義 (Book.vb)</h2>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
Public Class Book
    ...
    Public Property Location As ShopList
    Public Property BookInfo As Uri
End Class</pre>
<pre class="vb"><span class="visualBasic__com">'''&nbsp;&lt;summary&gt;</span>&nbsp;
<span class="visualBasic__com">'''&nbsp;店舗リスト</span>&nbsp;
<span class="visualBasic__com">'''&nbsp;&lt;/summary&gt;</span>&nbsp;
<span class="visualBasic__keyword">Public</span>&nbsp;<span class="visualBasic__keyword">Enum</span>&nbsp;ShopList&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;新宿&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;初台&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;大手町&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;赤坂&nbsp;
...
&nbsp;&nbsp;
<span class="visualBasic__com">'''&nbsp;&lt;summary&gt;</span>&nbsp;
<span class="visualBasic__com">'''&nbsp;エンティティクラス(書籍情報)</span>&nbsp;
<span class="visualBasic__com">'''&nbsp;&lt;/summary&gt;</span>&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Public</span>&nbsp;<span class="visualBasic__keyword">Property</span>&nbsp;Location&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;ShopList&nbsp;
...
<p>実行結果は以下のようになります。編集中の行以外が交互に別の色が用いられていることがおわかりいただけると思います。</p>
<p><img src="15595-image.png" alt=""></p>
<p>このように、DataGrid コントロールの Background プロパティ、RowBackground プロパティ、AlternatingRowBackground プロパティに背景となる
<a href="http://msdn.microsoft.com/ja-jp/library/system.windows.media.brush.aspx">
Brush</a> を指定することで見やすい表を表現することが可能です。</p>
<p>RowBackground プロパティ、AlternatingRowBackground プロパティは、背景の表示を AlternationIndex プロパティ、AlternationCount プロパティによって切り替えています。<br>
AlternationIndex プロパティは先頭行で 0 に初期化されて、行毎に 1 ずつ加算されます。そして、AlternationCount プロパティの設定値となると再度 0 に初期化されます。<br>
RowBackground プロパティは AlternationIndex プロパティが 0 となった際に表示される背景となり、AlternatingRowBackground プロパティは AlternationIndex が 1 となった際に表示される背景になります。<br>
AlternationCount プロパティは 2 以下が設定されていたら 2 がセットされたものとみなされます。<br>
AlternationIndex がその他の値の場合は背景が表示されません。<br>
参考までに AlternationCount プロパティに 4 を設定した場合の表示結果は以下のようになります。2 行目以下の行の背景が設定されていないことがおわかりいただけるかと思います。</p>
<p><img src="15596-image.png" alt=""></p>
<p>また、Background プロパティ、RowBackground プロパティ、AlternatingRowBackground プロパティは Brush 型のプロパティですので、LinearGradientBrush (線形グラデーション) など Brush の派生オブジェクトを指定することも可能です。例えば RowBackgound プロパティを以下のように設定するとグラデーションで背景が描画されます。</p>
<p style="margin-bottom:0px"><strong>グラデーションを用いた行の背景の描画 (変更箇所は太字の通り)</strong></p>
<div style="margin:2px 0px; padding:10px; background-color:#dedfde">
<p>&lt;DataGrid <br>
&nbsp;&nbsp;&nbsp;&nbsp;ItemsSource=&quot;{StaticResource BookData}&quot; <br>
&nbsp;&nbsp;&nbsp;&nbsp;Background=&quot;LightYellow&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;AlternatingRowBackground=&quot;Azure&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;<strong>&nbsp;&lt;DataGrid.RowBackground&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;LinearGradientBrush StartPoint=&quot;0,0.5&quot; EndPoint=&quot;1,0.5&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;GradientStop Color=&quot;Azure&quot; Offset=&quot;0&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;GradientStop Color=&quot;Blue&quot; Offset=&quot;1&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/LinearGradientBrush&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/DataGrid.RowBackground&gt;</strong><br>
&lt;/DataGrid&gt;</p>
</div>
<p>&nbsp;</p>
<p style="margin-bottom:0px"><strong>実行結果</strong></p>
<p style="margin-top:3px"><img src="15597-image.png" alt=""></p>
