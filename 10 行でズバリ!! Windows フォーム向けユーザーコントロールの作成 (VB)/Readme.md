...
<pre class="hidden"><code class="csharp">Private _textMessage As String = &quot;私のテスト文字列&quot;
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">&lt;DefaultValue(&quot;私のテスト文字列&quot;)&gt; _
...
今回のコントロールは System.Windows.Forms.UserControl から派生させたクラスに対してコントロールを貼り付ける形態でしたが、GDI&#43; グラフィック ライブラリを利用してコントロールのビジュアル表現を高めることも視野に入れ、さまざまなコントロール作成にチャレンジしてください。</p>
<p>&nbsp;</p>
