...
<a href="http://msdn.microsoft.com/ja-jp/library/84787k22(VS.80).aspx">String.Compare</a> メソッドを使用します。このメソッドは文字列の違いを int 型の値で返すため、同じ文字列と判定された場合は 0 を返します。</p>
...
namespace CodeRecipe_Compare_String_CS
{
    class Program
    {
        static void Main(string[] args)
        {
            string str1 = &quot;MSDNライブラリ CodeRecipe&quot;;
            string str2 = &quot;MSDNライブラリ CodeRecipe&quot;;

            Console.WriteLine(&quot;文字列1: {0}&quot;, str1);
            Console.WriteLine(&quot;文字列2: {0}&quot;, str2);
            
            int diff = string.Compare(str1, str2);
...
namespace CodeRecipe_Compare_String_CS
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string str1 = &quot;ＭＳＤＮﾗｲﾌﾞﾗﾘ　ＣｏｄｅＲｅｃｉｐｅ&quot;;
            string str2 = &quot;MSDNらいブラリ CodeRECIPE&quot;;
            ...
            int diff = string.Compare(str1, str2, ci, CompareOptions.IgnoreWidth | CompareOptions.IgnoreKanaType |  CompareOptions.IgnoreCase);
