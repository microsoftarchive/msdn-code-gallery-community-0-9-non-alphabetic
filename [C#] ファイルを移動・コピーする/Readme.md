...
<pre class="hidden"><code class="csharp">using System.IO;
...
<pre id="codePreview" class="csharp"><code class="csharp">using System.IO;
namespace CodeRecipe_CopyMoveFiles_CS
{
    class Program
    {
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">if (File.Exists(soucePath))
{
}</code></pre>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">File.Move(soucePath, targetPath);</code></pre>
...
<p>また、 Microsoft.VisualBasic アセンブリを参照に追加することで上書き確認ダイアログ表示の機能を使うことができます。</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">Microsoft.VisualBasic.Devices.Computer computer = new Computer();
computer.FileSystem.MoveFile(soucePath, targetPath, 
    Microsoft.VisualBasic.FileIO.UIOption.AllDialogs, 
    Microsoft.VisualBasic.FileIO.UICancelOption.DoNothing);</code></pre>
<pre id="codePreview" class="csharp"><code class="csharp">Microsoft.VisualBasic.Devices.Computer computer = new Computer();
computer.FileSystem.MoveFile(soucePath, targetPath, 
    Microsoft.VisualBasic.FileIO.UIOption.AllDialogs, 
    Microsoft.VisualBasic.FileIO.UICancelOption.DoNothing);</code></pre>
</div>
