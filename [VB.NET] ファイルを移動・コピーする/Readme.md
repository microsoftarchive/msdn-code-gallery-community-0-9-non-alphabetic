...
<pre class="hidden"><code class="csharp">Imports System.IO
Module Module1
    Sub Main()
    ...
    End Sub
End Module</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Imports System.IO
Module Module1
    Sub Main()
        Dim soucePath As String = &quot;C:\text\test.txt&quot;
        Dim targetPath As String = &quot;C:\text2\test.txt&quot;
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">If My.Computer.FileSystem.FileExists(soucePath) Then
End If</code></pre>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">My.Computer.FileSystem.CopyFile(soucePath, targetPath, _
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">My.Computer.FileSystem.MoveFile(soucePath, targetPath, _
                                         FileIO.UIOption.AllDialogs, FileIO.UICancelOption.DoNothing)</code></pre>
