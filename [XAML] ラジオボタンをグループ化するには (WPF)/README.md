...
<hr>
<h2>1. GroupName プロパティを使ったグループ化</h2>
<h4>Code 1 [XAML]</h4>
...
<pre id="codePreview" class="xaml"><code class="csharp">&lt;Window x:Class=&quot;RadioButton_WPF02_1_CS.Window1&quot;
    ...
    &lt;Grid&gt;
        ...
        &lt;!--RadioButton(ラジオボタン)のグループ化はGroupNameプロパティで行う--&gt;
        
        &lt;!--Group1--&gt;
        &lt;RadioButton 
            Grid.Row=&quot;0&quot; x:Name=&quot;rbA1&quot; GroupName=&quot;Group1&quot;&gt;Group1A&lt;/RadioButton&gt;
        &lt;RadioButton 
            Grid.Row=&quot;1&quot; x:Name=&quot;rbB1&quot; GroupName=&quot;Group1&quot;&gt;Group1B&lt;/RadioButton&gt;
        &lt;RadioButton 
            Grid.Row=&quot;2&quot; x:Name=&quot;rbC1&quot; GroupName=&quot;Group1&quot;&gt;Group1C&lt;/RadioButton&gt;

        &lt;!--Group2--&gt;
        &lt;RadioButton 
            Grid.Row=&quot;4&quot; x:Name=&quot;rbA2&quot; GroupName=&quot;Group2&quot;&gt;Group2A&lt;/RadioButton&gt;
        &lt;RadioButton 
            Grid.Row=&quot;5&quot; x:Name=&quot;rbB2&quot; GroupName=&quot;Group2&quot;&gt;Group2B&lt;/RadioButton&gt;
        &lt;RadioButton 
            Grid.Row=&quot;6&quot; x:Name=&quot;rbC2&quot; GroupName=&quot;Group2&quot;&gt;Group2C&lt;/RadioButton&gt;
        
        &lt;!--Group3--&gt;
        &lt;RadioButton 
            Grid.Row=&quot;8&quot; x:Name=&quot;rbA3&quot; GroupName=&quot;Group3&quot;&gt;Group3A&lt;/RadioButton&gt;
        &lt;RadioButton 
            Grid.Row=&quot;9&quot; x:Name=&quot;rbB3&quot; GroupName=&quot;Group3&quot;&gt;Group3B&lt;/RadioButton&gt;
        &lt;RadioButton 
            Grid.Row=&quot;10&quot; x:Name=&quot;rbC3&quot; GroupName=&quot;Group3&quot;&gt;Group3C&lt;/RadioButton&gt;
    &lt;/Grid&gt;
&lt;/Window&gt;</code></pre>
</div>
</div>
...
<h4>実行結果 1</h4>
<p><img src="15658-image.png" alt=""></p>
<hr>
<h2>2. Panel コントロールを使ったグループ化</h2>
<h4>Code 2 [XAML]</h4>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
...
<pre id="codePreview" class="xaml"><code class="csharp">&lt;Window x:Class=&quot;RadioButton_WPF02_2.Window1&quot;
    xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
    xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
    Title=&quot;Window1&quot; Height=&quot;300&quot; Width=&quot;300&quot;&gt;
    &lt;StackPanel&gt;
        &lt;!--Panelを用いてもグループ化できる--&gt;
        &lt;StackPanel&gt;
            &lt;RadioButton x:Name=&quot;rbA1&quot; Margin=&quot;5&quot;&gt;Group1A&lt;/RadioButton&gt;
            &lt;RadioButton x:Name=&quot;rbB1&quot; Margin=&quot;5&quot;&gt;Group1B&lt;/RadioButton&gt;
            &lt;RadioButton x:Name=&quot;rbC1&quot; Margin=&quot;5&quot;&gt;Group1C&lt;/RadioButton&gt;
        &lt;/StackPanel&gt;

        &lt;!--パネルを入れ子にすると入れ子にした各階層でグループ化される--&gt;
        &lt;StackPanel&gt;
            &lt;RadioButton x:Name=&quot;rbA2&quot; Margin=&quot;5&quot;&gt;Group2A&lt;/RadioButton&gt;
            &lt;RadioButton x:Name=&quot;rbB2&quot; Margin=&quot;5&quot;&gt;Group2B&lt;/RadioButton&gt;
            &lt;RadioButton x:Name=&quot;rbC2&quot; Margin=&quot;5&quot;&gt;Group2C&lt;/RadioButton&gt;

            &lt;StackPanel&gt;
                &lt;RadioButton x:Name=&quot;rbA3&quot; Margin=&quot;5&quot;&gt;Group3A&lt;/RadioButton&gt;
                &lt;RadioButton x:Name=&quot;rbB3&quot; Margin=&quot;5&quot;&gt;Group3B&lt;/RadioButton&gt;
                &lt;RadioButton x:Name=&quot;rbC3&quot; Margin=&quot;5&quot;&gt;Group3C&lt;/RadioButton&gt;
            &lt;/StackPanel&gt;
        &lt;/StackPanel&gt;
    &lt;/StackPanel&gt;
...
<h4>実行結果 2</h4>
<p><img src="15659-image.png" alt=""></p>
<hr>
<h2>ポイント</h2>
<p>ラジオボタン (RadioButton) コントロールは複数のコントロールを配置し、選択入力を行うためのコントロールです。そのため、選択を行うような項目が複数存在する場合、グループ化を行うことでグループ毎に選択入力ができるようになります。</p>
<p>ラジオボタン (RadioButton) コントロールではグループ化を行う場合は Code 1 のように、GroupName プロパティに文字列でグループ名を付与することでグループ化を行うことができます。</p>
<p>また、Code 2 のように、パネルに RadioButton を内包させることでパネルごとにグループ化を行うことも可能です。</p>
<p>グループ化は親のパネルを元に行われます。そのため、パネルを入れ子にした場合には 2 つ上位のグループとは関係なく、同じ階層のパネル内でグループ化が行われます。</p>
