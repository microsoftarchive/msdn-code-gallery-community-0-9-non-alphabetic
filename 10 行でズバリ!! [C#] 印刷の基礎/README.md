...
<tbody>
<tr>
<td style="padding:10px 10px 10px 10px"><img src="8973-image.png" alt=""> Visual Basic の内容はこちらに掲載しています。<a href="http://msdn.microsoft.com/ja-jp/silverlight/ff954088.aspx">10 行でズバリ!! [VB] 印刷の基礎</a></td>
</tr>
</tbody>
</table>
<h2><img src="8974-image.png" alt=""> このコンテンツのポイント</h2>
<ul>
<li>画面の印刷 </li><li>印刷ページの動的な作成 </li></ul>
<h2><img src="8975-image.png" alt=""> 今回紹介するコード</h2>
...
using <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Windows.Documents.aspx" target="_blank" title="Auto generated link to System.Windows.Documents">System.Windows.Documents</a>;
...
using <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Windows.Printing.aspx" target="_blank" title="Auto generated link to System.Windows.Printing">System.Windows.Printing</a>;
...
namespace SamplePrint
{
    public partial class MainPage : UserControl
    {
        ...
        void MainPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            people.Add(new Person() { Name = &quot;ビル・ゲイツ&quot;, Age = 54, Home = &quot;シアトル&quot; });
            people.Add(new Person() { Name = &quot;スティーブ・バルマー&quot;, Age = 54, Home = &quot;デトロイト&quot; });
            people.Add(new Person() { Name = &quot;レイ・オジー&quot;, Age = 55, Home = &quot;パークリッジ&quot; });
            DisplayPanel.DataContext = people;
        }
...
<h2>目次</h2>
<ol>
<li><a href="#01">はじめに</a> </li><li><a href="#02">サンプル アプリケーションの作成準備</a> </li><li><a href="#03">ユーザー インターフェイスの作成</a> </li><li><a href="#04">印刷用のデータを準備する</a> </li><li><a href="#05">画面を印刷する</a> </li><li><a href="#06">印刷ページの動的な作成</a> </li><li><a href="#07">おわりに</a> </li></ol>
<hr>
<h2 id="01">1. はじめに</h2>
<p>Silverlight 4 では、アプリケーションから直接印刷できるようになりました。従来の Silverlight では、画面を印刷するためにはブラウザーの印刷機能を使うしかなく、Silverlight の画面はスクリーン上のものがそのまま複製されていたため精細な文字が印刷できませんでした。Silverlight 4 の印刷機能は、スクリーンへの出力と同じモデルをそのままプリンター出力として利用することができるので、高品位な印刷が可能になります。</p>
<p>ここでは、簡単なアプリケーションを作成して、Silverlight の印刷機能について解説します。</p>
<p style="margin-top:20px"><a href="#top"><img src="8976-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="02">2. サンプル アプリケーションの作成準備</h2>
<p>まず、Visual Studio を起動して、[ファイル] メニューの [新規作成] から [プロジェクト] をクリックし、[新しいプロジェクト] を開きます。次に、[インストールされたテンプレート] で [Silverlight] カテゴリーにある [Silverlight アプリケーション] を選びます。[名前] には任意のプロジェクト名を指定できますが、ここでは「SamplePrint」とします。</p>
<p><img src="8977-image.png" alt=""></p>
...
<p><img src="8978-image.png" alt=""></p>
<p><strong>図 2. [新しい Silverlight アプリケーション] ダイアログ</strong></p>
<p>[OK] ボタンをクリックすると、SamplePrint ソリューションと、Silverlight アプリケーションのための SamplePrint プロジェクトが作成されます。</p>
<p><img src="8979-image.png" alt=""></p>
<p><strong>図 3. プロジェクト作成直後の Visual Studio 2010</strong></p>
<p style="margin-top:20px"><a href="#top"><img src="8980-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="03">3. ユーザー インターフェイスの作成</h2>
<p>今回は、DataGrid コントロールを使います。このために、まずソリューション エクスプローラーで SamplePrint プロジェクトの [参照設定] を右クリックして [参照の追加] を選び、[参照の追加] ダイアログ ボックスの [.NET] タブから「System.Windows.Controls.Data」を選んで、[OK] ボタンを押してください (図 4)。</p>
<p><img src="8981-image.png" alt=""></p>
<p><strong>図 4. [参照の追加] ダイアログ ボックス</strong></p>
<p>次に、MainPage.xaml に今回のアプリケーションで使うユーザー インターフェイスを作成します。今回は、画面を 2 分割して、上部には印刷用のボタンを置くための StackPanel を、下部にはデータを表示するための StackPanel を配置します。さらに下部の StackPanel にはリスト ボックス (ListBox) とデータ グリッド (DataGrid) を配置します。</p>
<div style="margin:20px 0px; padding:10px; background-color:#dedfde">
<p>&lt;UserControl x:Class=&quot;SamplePrint.MainPage&quot;<br>
...
&nbsp;&nbsp;<strong>&nbsp;xmlns:data=&quot;clr-namespace:<a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Windows.Controls.aspx" target="_blank" title="Auto generated link to System.Windows.Controls">System.Windows.Controls</a>;assembly=System.Windows.Controls.Data&quot;</strong><br>
&nbsp;&nbsp;&nbsp;mc:Ignorable=&quot;d&quot;<br>
...
&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;StackPanel Grid.Row=&quot;0&quot; x:Name=&quot;ButtonPanel&quot; Orientation=&quot;Horizontal&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;Button x:Name=&quot;btnPrint&quot; Padding=&quot;10,5,10,5&quot; Content=&quot;印刷&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/StackPanel&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;StackPanel Grid.Row=&quot;1&quot; x:Name=&quot;DisplayPanel&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;ListBox x:Name=&quot;listPeople&quot; MinHeight=&quot;50&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ItemsSource=&quot;{Binding}&quot; DisplayMemberPath=&quot;Name&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;data:DataGrid x:Name=&quot;dataPeople&quot; MinHeight=&quot;50&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ItemsSource=&quot;{Binding}&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/StackPanel&gt;</strong><br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Grid&gt;<br>
&lt;/UserControl&gt;</p>
</div>
<p>Visual Studio では、図 5 のように表示されます。</p>
<p><img src="8982-image.png" alt=""></p>
<p><strong>図 5. ユーザー インターフェイスを作成する様子</strong></p>
<div style="margin:10px 0; padding:10px 10px 0px 10px; background-color:#efefef; border:solid 1px #333333">
<p><strong>Note:</strong> ここではユーザー インターフェイスを作成するために直接 XAML コードを記述していますが、Visual Studio 2010 では、ツールボックスからデザイナー上にコントロールを配置できます。この場合は、上記で使われているコントロールの名前やバインディング設定を使うようにしてください。</p>
</div>
<p style="margin-top:20px"><a href="#top"><img src="8983-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="04">4. 印刷用のデータを準備する</h2>
<p>印刷用のプログラムを作成する前に、ユーザー インターフェイスで定義したコントロールにテスト用のデータを割り当てます。ここでは、リスト ボックス (listPeople) とデータ グリッド (dataPeople) が配置されている StackPanel (DisplayPanel) に対して、サンプル データのリストを割り当てています。データ コンテキストは配置された子コントロールに引き継がれるため、これにより 2 つのコントロールにデータが渡されます (listPeople では、DisplayMemberPath
 プロパティにより Name プロパティのみを表示しています)。</p>
<div style="margin:20px 0px; padding:10px; background-color:#dedfde">
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>this.Loaded &#43;= new RoutedEventHandler(MainPage_Loaded);</strong><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;void MainPage_Loaded(object sender, RoutedEventArgs e)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;var people = new List&lt;Person&gt;();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;people.Add(new Person() { Name = &quot;ビル・ゲイツ&quot;, Age = 54, Home = &quot;シアトル&quot; });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;people.Add(new Person() { Name = &quot;スティーブ・バルマー&quot;, Age = 54, Home = &quot;デトロイト&quot; });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;people.Add(new Person() { Name = &quot;レイ・オジー&quot;, Age = 55, Home = &quot;パークリッジ&quot; });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DisplayPanel.DataContext = people;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</strong><br>
&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;<strong>&nbsp;public class Person<br>
&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public string Name { get; set; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public int Age { get; set; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public string Home { get; set; }<br>
&nbsp;&nbsp;&nbsp;}</strong></p>
</div>
<p>このプログラムを実行した様子を図 6 に示します。</p>
<p><img src="8984-image.png" alt=""></p>
<p><strong>図 6. サンプル データを割り当てた様子</strong></p>
<p style="margin-top:20px"><a href="#top"><img src="8985-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="05">5. 画面を印刷する</h2>
<p>Silverlight 4 で追加された PrintDocument クラスを使うと、ユーザー インターフェイスの定義を容易に印刷できます。たとえば、画面全体をそのまま印刷するためには、次のようにプログラムします。</p>
<div style="margin:20px 0px; padding:10px; background-color:#dedfde">
<p>using <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Windows.Shapes.aspx" target="_blank" title="Auto generated link to System.Windows.Shapes">System.Windows.Shapes</a>;<br>
<strong>using <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Windows.Printing.aspx" target="_blank" title="Auto generated link to System.Windows.Printing">System.Windows.Printing</a>;</strong><br>
<br>
namespace SamplePrint<br>
{<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;btnPrint.Click &#43;= new RoutedEventHandler(btnPrint_Click);</strong><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&hellip;&hellip;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;private void btnPrint_Click(object sender, RoutedEventArgs e)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PrintDocument pdoc = new PrintDocument();<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pdoc.PrintPage &#43;= (s, args) =&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;args.PageVisual = LayoutRoot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pdoc.Print(&quot;印刷サンプル&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</strong><br>
&nbsp;&nbsp;&nbsp;}</p>
</div>
<p>この例では、PrintDocument のオブジェクト (pdoc) を生成し、Print メソッドを呼び出しており、この時点で印刷用のダイアログ ボックスが表示されます。出力先を選択して、[OK] ボタンを押すと印刷が開始されます。このとき、PrintPage イベントが発生するので、第 2 引数 args の PageVisual プロパティに、この画面の基礎である LayoutRoot (Grid コントロール) を割り当てています。</p>
<p><img src="8986-image.png" alt=""></p>
<p><strong>図 7. [印刷] ダイアログ ボックス</strong></p>
<p>Print メソッドに渡す文字列引数は、印刷文書の名称です。これは、印刷待ち表示などで使われます (図 7)。</p>
<p><img src="8987-image.png" alt=""></p>
<p><strong>図 8. 印刷待ち表示</strong></p>
<p>Microsoft XPS Document Writer を使って印刷 (出力) した場合、出力されたイメージは図 8 のようになります。</p>
<p><img src="8988-image.png" alt=""></p>
<p><strong>図 9. XPS として出力した結果を、XPS ビューアーで表示</strong></p>
<p>画面と同じ LayoutRoot を割り当てているため、ボタンを含めて印刷されていることがわかります。リスト ボックス (listPeople) とデータ グリッド (dataPeople) だけを印刷したい場合は、LayoutRoot の代わりに DisplayPanel を PageVisual プロパティに割り当てます。</p>
<p>なお、印刷する内容を PageVisual で割り当てているのは、印刷ページが複数に分かれる可能性を考慮しているためです。Silverlight における印刷は、ユーザーが開始しなければならない処理であり、プログラムで出力先や用紙サイズを変更することはできません。[印刷] ダイアログ ボックスで選択するまでは、どのような範囲に印刷できるかわかりません。一度に印刷しきれない場合は、PrintPage の第 2 引数 (PrintPageEventArgs 型) の HasMorePages プロパティを
 true にします。すると、再度 PrintPage が呼び出されるため、続くページを印刷するためのコントロールを割り当てることができます</p>
<p>この他、出力先を選択した直後 (かつ、PrintPage イベントの前) に発生する BeginPrint イベントや、印刷が終了した後に発生する EndPrint イベントが用意されています。</p>
<p style="margin-top:20px"><a href="#top"><img src="8989-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="06">6. 印刷ページの動的な作成</h2>
<p>上記のプログラムでは、画面用のコントロールをそのまま使って印刷しているため、出力先の用紙サイズに関わらず同じように出力しようとします。表示している画面サイズにより、右側が不自然に空いてしまったり、逆に用紙サイズが小さすぎて右端が欠けてしまうかもしれません。ユーザー インターフェイスを作成するコントロールは、実行時に動的に生成することもできるため、ここではプログラムで印刷ページを作成する例を紹介します。</p>
<p>次のプログラムでは、動的に Border を生成し、その中に DataGrid を配置しています。このとき Padding プロパティを使って、Border 中に置いた DataGrid と 20 ピクセル相当の隙間を空けています。データは、画面上の DataGrid に割り当てられているものをそのまま渡しています。</p>
<div style="margin:20px 0px; padding:10px; background-color:#dedfde">
<p>&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;&nbsp;&nbsp;private void btnPrint_Click(object sender, RoutedEventArgs e)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;var dynamicBorder = new Border();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dynamicBorder.Padding = new Thickness(20);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;var dGrid = new DataGrid();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dGrid.ItemsSource = dataPeople.ItemsSource;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dynamicBorder.Child = dGrid;<br>
&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PrintDocument pdoc = new PrintDocument();<br>
&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pdoc.PrintPage &#43;= (s, args) =&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;args.PageVisual = dynamicBorder;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pdoc.Print(&quot;印刷サンプル&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</strong></p>
</div>
<p>このプログラムを実行した様子を図 9 に示します。</p>
<p><img src="8990-image.png" alt=""></p>
<p><strong>図 10. 上部で右クリックした様子</strong></p>
<p>画面上のコントロールをそのまま使う場合と異なり、サイズが指定されていないため、印刷可能範囲全体が使われています。</p>
<p>実行中に印刷可能範囲を知るためには PrintPage イベント ハンドラーの第 2 引数 (PrintPageEventArgs 型) の PrintableArea プロパティ (Size 型) を使います。Silverlight では、解像度が 96 DPI (Dot Per Inch) に固定されていることに注意してください。A4 サイズ (縦 297 mm &times; 横 210 mm) で印刷する場合、PrintableArea の Width プロパティ (横方向) は 297 &divide;
 25.4 &times; 96 ＝ 1122 ピクセル、Height プロパティ (縦方向) は 793 ピクセルになります。</p>
<p>実際のプリンターに出力する場合は、通常、紙の端に余白 (マージン) が必要です。余白のサイズは PageMargins プロパティ (Thickness 型) で得られます。たとえば、余白が 5 mm 必要な場合は、3 &divide; 25.4 &times; 96 ＝ 18 ピクセルが PageMargins プロパティのそれぞれのメンバーに設定されます。また、PrintableArea のサイズは、これらの余白を引いた値になります。</p>
<p style="margin-top:20px"><a href="#top"><img src="8991-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="07">7. おわりに</h2>
<p>日本では帳票の文化が根強いので、入力とともに、印刷の機能が重要視されることが多いことはご存じの通りです。これまでの Web アプリケーションでは、Web ブラウザーの印刷機能を利用せざるを得ませんでしたが、今回、Silverlight 4 が印刷機能を実装したことは、エンタープライズにおける信&#38972;性がさらに前進したと言えるでしょう。</p>
<hr>
<div>
<table>
<tbody>
