...
<div id="top">
<p>更新日: 2010 年 10 月 29 日</p>
<table border="0" cellspacing="0" cellpadding="5" bgcolor="#e5f1f8" style="margin-bottom:10px">
<tbody>
<tr>
<td style="padding:10px 10px 10px 10px"><img src="9326-image.png" alt=""> Visual Basic の内容はこちらに掲載しています。<a href="http://msdn.microsoft.com/ja-jp/netframework/gg288259.aspx">10 行でズバリ!! [VB] Web ユーザー コントロールの作成</a></td>
</tr>
</tbody>
</table>
<h2><img src="9327-image.png" alt=""> このコンテンツのポイント</h2>
<ul>
<li>Web ユーザー コントロールの作成方法を理解する </li><li>Web ユーザー コントロールの使用方法を理解する </li></ul>
<h2><img src="9328-image.png" alt=""> 今回紹介するコード</h2>
...
<pre id="codePreview" class="csharp"><code class="csharp">public partial class MyControl : <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Web.UI.UserControl.aspx" target="_blank" title="Auto generated link to System.Web.UI.UserControl">System.Web.UI.UserControl</a>
    {
        public <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Drawing.Color.aspx" target="_blank" title="Auto generated link to System.Drawing.Color">System.Drawing.Color</a> Color { get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DropDownList1.Items.Add(&quot;Cyan&quot;);
                DropDownList1.Items.Add(&quot;Yellow&quot;);
                DropDownList1.Items.Add(&quot;White&quot;);
                DropDownList1.SelectedIndex = 0;
            }
            Color = <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Drawing.Color.FromName.aspx" target="_blank" title="Auto generated link to System.Drawing.Color.FromName">System.Drawing.Color.FromName</a>(DropDownList1.SelectedValue.ToString());
        }
    }</code></pre>
</div>
</div>
...
<h2>目次</h2>
<ol>
<li><a href="#01">はじめに</a> </li><li><a href="#02">サンプル Web アプリケーションの作成準備</a> </li><li><a href="#03">Web ユーザー コントロールの作成</a> </li><li><a href="#04">Web ユーザー コントロールの使用</a> </li><li><a href="#05">おわりに</a> </li></ol>
<hr>
<h2 id="01">1. はじめに</h2>
<p>Web アプリケーションを作成する場合、複数の異なる Web ページで、同じユーザー インターフェイスや機能を使いたいことがあります。このとき、それぞれのページごとに繰り返しユーザー インターフェイスを作成するのは非効率です。</p>
<p>ASP.NET では、いくつかのコントロールや機能から構成されるユーザー インターフェイスを、Web ユーザー コントロールという一つの部品として構築し、複数の異なるページで再利用できます。</p>
<p>ここでは、簡単な Web アプリケーションを作成して、Web ユーザー コントロールの作成方法と使用方法について解説します。</p>
<p style="margin-top:20px"><a href="#top"><img src="9329-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="02">2. サンプル Web アプリケーションの作成準備</h2>
<p>まず、Visual Studio を起動して、[ファイル] メニューの [新規作成] から [プロジェクト] をクリックし、[新しいプロジェクト] を開きます。次に、[インストールされたテンプレート] で [Web] カテゴリーにある [ASP.NET Web アプリケーション] を選びます。[名前] には任意のプロジェクト名を指定できますが、ここでは「SiteControl」とします。</p>
<p><img src="9330-image.png" alt=""></p>
<p><strong>図 1. [新しい Web サイト] ダイアログで 、ファイル システム上に Web サイトを新規作成</strong></p>
<p>[OK] をクリックすると、SiteControl という新しい Web サイト用のプロジェクトと、ソリューションが作成されます。</p>
<p>&nbsp;</p>
<p><img src="9331-image.png" alt=""></p>
<p><strong>図 2. プロジェクト作成直後の Visual Studio 2010</strong></p>
<p style="margin-top:20px"><a href="#top"><img src="9332-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="03">3. Web ユーザー コントロールの作成</h2>
<p>新しい Web ユーザー コントロールを追加するため、ソリューション エクスプローラーで SiteConfig プロジェクトを右クリックし、[追加] - [新しい項目] を選びます。すると、「新しい項目の追加」ダイアログが表示されるので、[Web ユーザー コントロール] を選び、名前を「MyControl.ascx」にして、[追加] ボタンを押します (図 3)。</p>
<p><img src="9333-image.png" alt=""></p>
<p><strong>図 3. 新しく Web ユーザー コントロールを追加する</strong></p>
<p>編集画面には、MyControl.ascx のソース ビューが表示されます。ここで左下にある [デザイン] タブをクリックして、デザイン ビューに切り替えます。Web ユーザー コントロールも、通常の Web フォームと同じようにコントロールを配置したり、イベント ハンドラーを割り当てて画面や機能を実装します。ここでは、図 4 のように「色:」というテキストを記述した後、DropDownList コントロールを配置します。</p>
<p><img src="9334-image.png" alt=""></p>
<p><strong>図 4. Web ユーザー コントロールの作成</strong></p>
<p>[F7] キーを押すか、ソリューション エクスプローラーで MyControl.ascx 下にある MyControl.ascx.cs をダブルクリックして、コード エディターを開きます。ここで次のように Color プロパティを追加し、Page_Load イベント ハンドラーを記述します。</p>
<div style="margin:5px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>namespace SiteControl<br>
{<br>
&nbsp;&nbsp;&nbsp;public partial class MyControl : <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Web.UI.UserControl.aspx" target="_blank" title="Auto generated link to System.Web.UI.UserControl">System.Web.UI.UserControl</a><br>
&nbsp;&nbsp;&nbsp;{<br>
<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Drawing.Color.aspx" target="_blank" title="Auto generated link to System.Drawing.Color">System.Drawing.Color</a> Color { get; set; }</strong><br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;protected void Page_Load(object sender, EventArgs e)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!IsPostBack)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DropDownList1.Items.Add(&quot;Blue&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DropDownList1.Items.Add(&quot;Red&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DropDownList1.Items.Add(&quot;Green&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DropDownList1.Items.Add(&quot;Cyan&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DropDownList1.Items.Add(&quot;Yellow&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DropDownList1.Items.Add(&quot;White&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DropDownList1.SelectedIndex = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Color = <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Drawing.Color.FromName.aspx" target="_blank" title="Auto generated link to System.Drawing.Color.FromName">System.Drawing.Color.FromName</a>(DropDownList1.SelectedValue.ToString());</strong><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;}<br>
}</p>
</div>
<p>この Web ユーザー コントロールが配置されたページが呼び出されたり、そのページ上のボタンが押されてサーバーに要求が送信されたりして (ポストバック)、サーバー サイドで処理が行われるたびに、Page_Load が呼び出されます。このため、最初の呼び出しのときには、DropDownList にいくつかの色名を追加し、ポストバックのときには色名の追加をスキップします。Color プロパティには現在選択されている値 (SelectedValue) の文字列から、色の値 (Color 型) を取り出して割り当てています。</p>
<p>なお、次のように記述すれば、あらかじめライブラリの KnownColor クラスに定義されているすべての色名を DropDownList に割り当てることができます。</p>
<div style="margin:5px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>&nbsp;&nbsp;&nbsp;public partial class MyControl : <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Web.UI.UserControl.aspx" target="_blank" title="Auto generated link to System.Web.UI.UserControl">System.Web.UI.UserControl</a><br>
&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Drawing.Color.aspx" target="_blank" title="Auto generated link to System.Drawing.Color">System.Drawing.Color</a> Color { get; set; }<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;protected void Page_Load(object sender, EventArgs e)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!IsPostBack)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;var colors = from prop in typeof(<a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Drawing.KnownColor.aspx" target="_blank" title="Auto generated link to System.Drawing.KnownColor">System.Drawing.KnownColor</a>).GetEnumNames()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;select prop.ToString();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;foreach (var color in colors)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DropDownList1.Items.Add(color);</strong><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;}</p>
</div>
<p style="margin-top:20px"><a href="#top"><img src="9335-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="04">4. Web ユーザー コントロールの使用</h2>
<p>作成した Web ユーザー コントロールを使う Web ページを作成します。編集画面の上部にある [Default.aspx] タブをクリックするか、ソリューション エクスプローラーで Default.aspx をダブルクリックしてください。さらに、左下の [デザイン] タブをクリックして、デザイン ビューに切り替えます。</p>
<p>次に、ソリューション エクスプローラーの MyControl.ascx をドラッグ アンド ドロップして、Default.aspx 上に配置します (図 5)。</p>
<p><img src="9336-image.png" alt=""></p>
<p><strong>図 5. 作成した Web ユーザー コントロールを配置する</strong></p>
<p>さらに、Button と Label コントロールを、Default.aspx 上に追加します (図 6)。</p>
<p><img src="9337-image.png" alt=""></p>
<p><strong>図 6. Button と Label を配置した様子</strong></p>
<p>Button コントロールをダブルクリックして、次のようなイベント ハンドラーを割り当てます。</p>
<div style="margin:5px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;protected void Button1_Click(object sender, EventArgs e)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Label1.BackColor = MyControl1.Color;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Label1.Text = MyControl1.Color.ToString();</strong><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</p>
</div>
<p>ここでは、作成した Web ユーザー コントロール (MyControl) の Color プロパティを Label の背景色 (BackColor プロパティ) に、Color プロパティを文字列として取り出したものを Label のテキスト (Text プロパティ) に割り当てています。</p>
<p>プログラムを実行した様子を図 7 に示します。</p>
<p><img src="9338-image.png" alt=""></p>
<p><strong>図 7. Web ユーザー コントロールを使用している様子</strong></p>
<p>この Web アプリケーションを起動すると、次の順序でイベントが発生します。</p>
<ol>
<li>Default.aspx (Web ページ) の Page_Load イベント </li><li>MyControl.ascx (Web ユーザー コントロール) の Page_Load イベント </li></ol>
<p>さらにボタンをクリックすると、次の順序でイベントが発生します。</p>
<ol>
<li>Default.aspx (Web ページ) の Page_Load イベント (ポストバック) </li><li>MyControl.ascx (Web ユーザー コントロール) の Page_Load イベント (ポストバック) </li><li>Default.aspx (Web ページ) の Button1_Click イベント </li></ol>
<p style="margin-top:20px"><a href="#top"><img src="9339-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
<h2 id="05">5. おわりに</h2>
<p>複数の Web ページに対して、全体的なデザインの一貫性を実現するためにはマスター ページという手段が用意されていますが、部品レベルでの再利用性を高めるためには、Web ユーザー コントロールが便利です。一度デバッグしておけば、繰り返しデザインやコーディングする手間がなくなります。</p>
<p>&nbsp;</p>
<hr>
<div>
<table>
