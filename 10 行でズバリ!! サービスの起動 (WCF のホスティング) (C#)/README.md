...
<pre id="codePreview" class="csharp"><code class="csharp">using <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.ServiceModel.aspx" target="_blank" title="Auto generated link to System.ServiceModel">System.ServiceModel</a>;
. . . . .
...
<p><img src="9972-image.png" alt=""></p>
<p><strong>図 1. プロジェクト テンプレートを選択してプロジェクトを作成</strong></p>
<p>以降では、WCF のランタイムと、前述であらかじめ用意した WCF サービスを使用します。</p>
<p>このため、Visual Studio の [プロジェクト] メニューの [参照の追加] を選択して、<a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.ServiceModel.aspx" target="_blank" title="Auto generated link to System.ServiceModel">System.ServiceModel</a> を選択して [OK] ボタンをクリックします。(図 2)</p>
<p><img src="9973-image.png" alt=""></p>
<p><strong>図 2. 参照の追加 (<a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.ServiceModel.aspx" target="_blank" title="Auto generated link to System.ServiceModel">System.ServiceModel</a>)</strong></p>
...
<hr>
<h2 id="05">5. サービス構成 (.config) を作成する</h2>
...
<p><img src="9980-image.png" alt=""></p>
...
<p><img src="9983-image.png" alt=""></p>
...
<p><img src="9986-image.png" alt=""></p>
...
<p>最後に、サービスを選択し、[BehaviorConfiguration] 欄で、上記で作成したサービス動作 (名称: NewBehavior) を選択します。(図 15)</p>
...
<p><img src="9991-image.png" alt=""></p>
