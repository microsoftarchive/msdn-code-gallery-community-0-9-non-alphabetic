# 連載! とことん VB: 第 8 回 For Each ... Next ループ対応のコレクション ～IEnumerable と 3 種類の実装パターン～
## License
...
<p style="margin-top:20px"><a href="#top"><img src="17044-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
