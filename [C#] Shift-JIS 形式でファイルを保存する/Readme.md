...
<p>このように、System.IO.StreamWriter のコンストラクターに Encoding.GetEncoding (&quot;shift_jis&quot;) と指定することで既定のエンコーディングである UTF-8 ではなく、Shift-JIS 形式で保存することが可能となります。</p>
...
</li><li><strong>Encoding クラス (System.Text)</strong><br>
