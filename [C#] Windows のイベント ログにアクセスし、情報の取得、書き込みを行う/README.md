...
namespace CodeRecipe_EventLog_CS
{
    class Program
    {
...
<p>アプリケーション マニフェストの設定方法については <a href="http://msdn.microsoft.com/ja-jp/windows/ff467965.aspx">
[C#] .NET Framework 対応アプリケーションの起動の際に、管理者に昇&#26684;させる</a>を参照してください。</p>
<h3>関連リンク</h3>
<ul>
