...
<pre class="hidden"><code class="csharp">Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
...
End Sub</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
    Dim textBox1OfMasterPage As TextBox
    textBox1OfMasterPage = Master.FindControl (&quot;TextBox1&quot;)
    Label1.Text = &quot;Page 2 : &quot; &#43; textBox1OfMasterPage.Text
End Sub</code></pre>
