Namespace WebApplication
  Public Class OEM
    ...
    Public Const SkinAtFirstStartup As String = "Christmas" 'Is case sensitive and the first char must be uppercase! Ex.: "Default", "Best Skyn".
    Public Const SoundAtFirstStartup As String = "james_pond2.mod" '.mod file run when create a supervisor account
