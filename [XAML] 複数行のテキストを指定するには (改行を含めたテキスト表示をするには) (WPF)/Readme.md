# [XAML] 複数行のテキストを指定するには (改行を含めたテキスト表示をするには) (WPF)
## Requires
- 
## License
...
<pre class="hidden"><code class="csharp">&lt;Window x:Class=&quot;TextBlock_WPF04.Window1&quot;
    xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
    xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
    Title=&quot;Window1&quot; Height=&quot;300&quot; Width=&quot;300&quot;&gt;
    &lt;StackPanel x:Name=&quot;LayoutRoot&quot;&gt;
        &lt;!--複数行のテキストはLineBreak要素を指定することで改行することができる--&gt;
        ...
        &lt;!--正攻法ではないがTextWrappingプロパティ[折り返し]とWidthプロパティ[幅]を組み合わせて改行することも可能--&gt;
        &lt;TextBlock HorizontalAlignment=&quot;Left&quot; Margin=&quot;10&quot;  TextWrapping=&quot;Wrap&quot; Width=&quot;50&quot;&gt;
            Line1
            Line2
            Line3
            Line4
    ...
    &lt;/StackPanel&gt;
&lt;/Window&gt;</code></pre>
<pre id="codePreview" class="xaml"><code class="csharp">&lt;Window x:Class=&quot;TextBlock_WPF04.Window1&quot;
    xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
    xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
    Title=&quot;Window1&quot; Height=&quot;300&quot; Width=&quot;300&quot;&gt;
    &lt;StackPanel x:Name=&quot;LayoutRoot&quot;&gt;
...
<h2>実行結果</h2>
<p><img src="15683-image.png" alt=""></p>
<h2>ポイント</h2>
<p>TextBlock で複数行にわたるテキストの表示を行うには通常テキストの改行位置に LineBreak 要素を配置することで改行することが可能です。</p>
<p>LineBreak 要素は指定された位置でテキストを改行し、後続するテキストを次の行頭から表示することができます。</p>
<p>同じような動作をテキストの折り返しの指定を行う TextWrapping プロパティおよびコントロールの表示幅を指定する Width プロパティを使って行うと、テキストの折り返しにより後続するテキストを次行に表示させることは可能ですが、コントロールの幅が変わることによりコントロールそのものの表示位置の指定を行っていないと同様の表示にはなりません。</p>
<p>そのため、コントロールを同じように表示させるにはコントロール位置の調整等、他の調整も伴うため注意が必要になります。</p>
