...
<p><img src="25244-img07_01.gif" alt="図 7.1" width="600" height="346"></p>
...
<p><img src="25246-img07_03.gif" alt="図 7.3" width="580" height="334"></p>
...
<p><img src="25247-img07_04.jpg" alt="図 7.4" width="580" height="169"></p>
...
#define IDR_SMALLTEXTTYPE 800  //子ウィンドウ、ドキュメントテンプレートのリソースID

#define IDC_EDIT1 1000         //EDITコントロールのID &larr;[1]</pre>
<div class="preview">
...
<p><img src="25252-img07_09.gif" alt="図 7.9" width="600" height="418"></p>
...
<div class="pluginLinkHolder"><span class="pluginEditHolderLink">スクリプトの編集</span>|<span class="pluginRemoveHolderLink">{#scriptcode_dlg.remove_script}</span></div>
<span class="hidden">cplusplus</span>
<pre class="hidden">// SmallView.cpp
#include &quot;stdafx.h&quot;
#include &quot;SmallDoc.h&quot;
#include &quot;SmallView.h&quot;
...
<p><img src="25256-img07_13.gif" alt="図 7.13" width="600" height="455"></p>
...
<div class="pluginLinkHolder"><span class="pluginEditHolderLink">スクリプトの編集</span>|<span class="pluginRemoveHolderLink">{#scriptcode_dlg.remove_script}</span></div>
<span class="hidden">cplusplus</span>
<pre class="hidden">// CSmallApp.cpp
#include &quot;stdafx.h&quot;
#include &quot;SmallApp.h&quot;
...
BEGIN_MESSAGE_MAP(CSmallApp, CWinApp)               //&larr;[2]
    ON_COMMAND(ID_FILE_NEW, &amp;CWinApp::OnFileNew)    //&larr;[3]
    ON_COMMAND(ID_FILE_OPEN, &amp;CWinApp::OnFileOpen)  //&larr;[4]
END_MESSAGE_MAP()
...
<p><img src="25257-img07_14.jpg" alt="図 7.14" width="600" height="432"></p>
...
<p><img src="25258-img07_15.gif" alt="図 7.15" width="580" height="302"></p>
