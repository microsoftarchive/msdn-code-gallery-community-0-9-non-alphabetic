...
<pre class="hidden"><code class="csharp">Imports System.Text
...
End Class</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Imports System.Text
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Imports System.Reflection
Imports System.IO
...
End Module</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Imports System.Reflection
Imports System.IO
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Dim asm As Assembly = Assembly.Load(&quot;MyLibrary&quot;)
Dim myType As Type = asm.GetType(&quot;MyLibrary.MyBirthday&quot;)
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Dim obj = Activator.CreateInstance(myType)
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">誕生日を入力してください(yyyy/MM/dd):1978/08/13
