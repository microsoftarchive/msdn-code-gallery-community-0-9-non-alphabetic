...
<pre id="codePreview" class="xaml"><code class="csharp">&lt;Window x:Class=&quot;TextBox_WPF05.Window1&quot;
    ...
    &lt;StackPanel&gt;
        ...
        &lt;!--Color列挙体による指定--&gt;
        &lt;TextBox Text=&quot;Color列挙体&quot; TextWrapping=&quot;Wrap&quot; Foreground=&quot;Red&quot; Background=&quot;LightBlue&quot;/&gt;

        &lt;!--RGBA値による指定--&gt;
        &lt;TextBox Text=&quot;RGBA値&quot; TextWrapping=&quot;Wrap&quot; Foreground=&quot;#FF0054FF&quot; Background=&quot;#FF94FF8B&quot;/&gt;

        &lt;!--Brushオブジェクトを指定--&gt;
        &lt;TextBox Text=&quot;Brushを指定&quot; TextWrapping=&quot;Wrap&quot; Foreground=&quot;Red&quot;&gt;
            &lt;TextBox.Background&gt;
                &lt;LinearGradientBrush EndPoint=&quot;0.5,1&quot; StartPoint=&quot;0.5,0&quot;&gt;
                    &lt;GradientStop Color=&quot;Black&quot; Offset=&quot;0&quot;/&gt;
                    &lt;GradientStop Color=&quot;#FFE15353&quot; Offset=&quot;1&quot;/&gt;
                &lt;/LinearGradientBrush&gt;
            &lt;/TextBox.Background&gt;
        &lt;/TextBox&gt;
    &lt;/StackPanel&gt;
...
<h2>実行結果</h2>
<p><img src="15576-image.png" alt=""></p>
<h2>ポイント</h2>
<p>前景色・背景色の指定は Foreground プロパティ、Background プロパティに行います。</p>
<p>Foreground プロパティ、Background プロパティは Brush 型ですので Brush 型のオブジェクトが設定可能です。</p>
<p>Brush クラスには Color 構造体に定義されている静的プロパティや RGB 値から単色 SolidColorBrush へ変換を行ってくれる TypeConverter が関連付けされているため、XAML では Color 構造体の文字列か RGB 値を入力すると自動的に単色ブラシ オブジェクトへ変換されます。</p>
<p>指定方法は</p>
<table border="0" cellspacing="2" cellpadding="1" width="100%">
<tbody>
<tr align="left" valign="top">
<td width="100">Color 構造体</td>
<td>Color 構造体に定義されている静的プロパティのメンバー名</td>
</tr>
<tr align="left" valign="top">
<td width="150">RGB 値</td>
<td>複数指定方法有</td>
</tr>
</tbody>
</table>
<p style="margin-top:10px">#rgb<br>
3 文字の 16 進値。1 文字目はその色の R 値、2 文字目は G 値、3 文字目は B 値をそれぞれ指定します。たとえば、00F のように指定します。</p>
<p>#argb<br>
4 文字の 16 進値。1 文字目はその色の A 値、2 文字目は R 値、3 文字目は G 値、4 文字目は B 値をそれぞれ指定します。たとえば、F00F のように指定します。</p>
<p>#rrggbb<br>
6 文字の 16 進値。最初の 2 文字はその色の R 値、次の 2 文字は G 値、最後の 2 文字は B 値をそれぞれ指定します。たとえば、0000FF のように指定します。</p>
<p>#aarrggbb<br>
8 文字の 16 進値。最初の 2 文字はその色の A 値、次の 2 文字は R 値、その次の 2 文字は G 値、最後の 2 文字は B 値をそれぞれ指定します。たとえば、FF0000FF などです。</p>
<p>などの方法により色の指定を行います。</p>
<p>1 つめのサンプルは Color 構造体を指定する方法、2 つめのサンプルは #aarrggbb を指定する方法になります。</p>
<p>3 つめのサンプルは通常の Brush オブジェクトを指定しても指定する方法になります。こちらのサンプルでは線形グラデーションのブラシ オブジェクトである LinearGradientBrush を指定しています。</p>
<p>指定できる Brush オブジェクトは以下の通りです。</p>
<table border="0" cellspacing="2" cellpadding="1" width="100%">
<tbody>
<tr width="200" align="left" valign="top">
<td>SolidColorBrush</td>
<td>単色のブラシ</td>
</tr>
<tr align="left" valign="top">
<td>LinearGradientBrush</td>
<td>線形グラデーション ブラシ</td>
</tr>
<tr align="left" valign="top">
<td>RadialGradientBrush</td>
<td>放射状グラデーション ブラシ</td>
</tr>
<tr align="left" valign="top">
<td>ImageBrush</td>
<td>画像 (Image) を利用したブラシ</td>
</tr>
<tr align="left" valign="top">
<td>DrawingBrush</td>
<td>Drawing オブジェクトを利用したブラシ、ベクター グラフィック、ビットマップ オブジェクトなどを指定することができるブラシ</td>
</tr>
<tr align="left" valign="top">
<td>VisualBrush</td>
<td>Visual オブジェクトを利用したブラシ</td>
</tr>
</tbody>
</table>
<h2>参考</h2>
<p>Color 構造体<br>
<a href="http://msdn.microsoft.com/ja-jp/library/system.windows.media.color.aspx">http://msdn.microsoft.com/ja-jp/library/system.windows.media.color.aspx</a></p>
