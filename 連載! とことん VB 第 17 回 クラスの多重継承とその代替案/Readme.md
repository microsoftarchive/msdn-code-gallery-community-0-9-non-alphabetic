...
<pre class="hidden"><code class="csharp">Public Class A			&larr;[1]
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Public Interface IShip		&larr;[1]
    Sub FloatAndMove()
End Interface
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Public Class Ship		&larr; [1]
