# [XAML/VB/C#] コンボ ボックス (ComboBox) で選択された項目を取得するには (Silverlight)
## Requires
- 
## License
...
<p>動作確認環境: Visual Studio 2008 SP1、Silverlight 3、VS2008 SP1 用 Silverlight 3 Toolkit</p>
<p>更新日: 2010 年 5 月 14 日</p>
<hr>
<h2>Code [XAML]</h2>
...
<pre class="hidden">&lt;UserControl x:Class=&quot;ComboBox_SL06.MainPage&quot;
    ...
    &lt;/Grid&gt;
&lt;/UserControl&gt;</pre>
<pre class="csharp">&lt;UserControl&nbsp;x:Class=<span class="cs__string">&quot;ComboBox_SL06.MainPage&quot;</span>&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;xmlns:d=<span class="cs__string">&quot;http://schemas.microsoft.com/expression/blend/2008&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;xmlns:mc=<span class="cs__string">&quot;http://schemas.openxmlformats.org/markup-compatibility/2006&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;mc:Ignorable=<span class="cs__string">&quot;d&quot;</span>&nbsp;d:DesignWidth=<span class="cs__string">&quot;640&quot;</span>&nbsp;d:DesignHeight=<span class="cs__string">&quot;480&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;Loaded=<span class="cs__string">&quot;UserControl_Loaded&quot;</span>&gt;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&lt;Grid&nbsp;x:Name=<span class="cs__string">&quot;LayoutRoot&quot;</span>&gt;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;Grid.RowDefinitions&gt;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Grid.RowDefinitions&gt;&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;ComboBox&nbsp;x:Name=<span class="cs__string">&quot;ComboBox1&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DisplayMemberPath=<span class="cs__string">&quot;Name&quot;</span>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Margin=<span class="cs__string">&quot;5&quot;</span>&nbsp;/&gt;&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!--ComboBoxのSelectedItemには選択されたオブジェクトが取得できる--&gt;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox&nbsp;Grid.Row=<span class="cs__string">&quot;3&quot;</span>&nbsp;Margin=<span class="cs__string">&quot;5&quot;</span>&nbsp;Text=<span class="cs__string">&quot;{Binding&nbsp;SelectedItem.Name,&nbsp;ElementName=ComboBox1}&quot;</span>&nbsp;/&gt;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Grid&gt;&nbsp;
&lt;/UserControl&gt;&nbsp;
&nbsp;
</pre>
...
namespace ComboBox_SL06
{
    public partial class MainPage : UserControl
    {
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            persons.Add(new Person() { ID = 1, Name = &quot;新宿　一郎&quot; });
            persons.Add(new Person() { ID = 2, Name = &quot;初台　次郎&quot; });
            persons.Add(new Person() { ID = 3, Name = &quot;大手町　三郎&quot; });
            persons.Add(new Person() { ID = 4, Name = &quot;代田橋　四朗&quot; });
            persons.Add(new Person() { ID = 5, Name = &quot;赤坂　五郎&quot; });
...
&nbsp;
<span class="cs__keyword">namespace</span>&nbsp;ComboBox_SL06&nbsp;
{&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;List&lt;Person&gt;&nbsp;persons&nbsp;=&nbsp;<span class="cs__keyword">new</span>&nbsp;List&lt;Person&gt;();&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;persons.Add(<span class="cs__keyword">new</span>&nbsp;Person()&nbsp;{&nbsp;ID&nbsp;=&nbsp;<span class="cs__number">1</span>,&nbsp;Name&nbsp;=&nbsp;<span class="cs__string">&quot;新宿　一郎&quot;</span>&nbsp;});&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;persons.Add(<span class="cs__keyword">new</span>&nbsp;Person()&nbsp;{&nbsp;ID&nbsp;=&nbsp;<span class="cs__number">2</span>,&nbsp;Name&nbsp;=&nbsp;<span class="cs__string">&quot;初台　次郎&quot;</span>&nbsp;});&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;persons.Add(<span class="cs__keyword">new</span>&nbsp;Person()&nbsp;{&nbsp;ID&nbsp;=&nbsp;<span class="cs__number">3</span>,&nbsp;Name&nbsp;=&nbsp;<span class="cs__string">&quot;大手町　三郎&quot;</span>&nbsp;});&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;persons.Add(<span class="cs__keyword">new</span>&nbsp;Person()&nbsp;{&nbsp;ID&nbsp;=&nbsp;<span class="cs__number">4</span>,&nbsp;Name&nbsp;=&nbsp;<span class="cs__string">&quot;代田橋　四朗&quot;</span>&nbsp;});&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;persons.Add(<span class="cs__keyword">new</span>&nbsp;Person()&nbsp;{&nbsp;ID&nbsp;=&nbsp;<span class="cs__number">5</span>,&nbsp;Name&nbsp;=&nbsp;<span class="cs__string">&quot;赤坂　五郎&quot;</span>&nbsp;});&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ComboBox1.ItemsSource&nbsp;=&nbsp;persons;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;
...
<div class="pluginEditHolderLink">{#scriptcode_dlg.edit_script}</div>
<span class="hidden">csharp</span>
<pre class="hidden">namespace ComboBox_SL06
{
    public class Person
    {
        private int _id;
...
<pre class="csharp"><span class="cs__keyword">namespace</span>&nbsp;ComboBox_SL06&nbsp;
{&nbsp;
...
<pre class="hidden">Partial Public Class MainPage
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs)
        Dim personData As New List(Of Person)

        personData.Add(New Person(1, &quot;新宿　一郎&quot;))
        personData.Add(New Person(2, &quot;初台　次郎&quot;))
        personData.Add(New Person(3, &quot;大手町　三郎&quot;))
        personData.Add(New Person(4, &quot;代田橋　四朗&quot;))
        personData.Add(New Person(5, &quot;赤坂　五郎&quot;))

        ComboBox1.ItemsSource = personData
    End Sub
End Class</pre>
...
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Private</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;UserControl_Loaded(<span class="visualBasic__keyword">ByVal</span>&nbsp;sender&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;System.<span class="visualBasic__keyword">Object</span>,&nbsp;<span class="visualBasic__keyword">ByVal</span>&nbsp;e&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;System.Windows.RoutedEventArgs)&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Dim</span>&nbsp;personData&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;<span class="visualBasic__keyword">New</span>&nbsp;List(<span class="visualBasic__keyword">Of</span>&nbsp;Person)&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;personData.Add(<span class="visualBasic__keyword">New</span>&nbsp;Person(<span class="visualBasic__number">1</span>,&nbsp;<span class="visualBasic__string">&quot;新宿　一郎&quot;</span>))&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;personData.Add(<span class="visualBasic__keyword">New</span>&nbsp;Person(<span class="visualBasic__number">2</span>,&nbsp;<span class="visualBasic__string">&quot;初台　次郎&quot;</span>))&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;personData.Add(<span class="visualBasic__keyword">New</span>&nbsp;Person(<span class="visualBasic__number">3</span>,&nbsp;<span class="visualBasic__string">&quot;大手町　三郎&quot;</span>))&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;personData.Add(<span class="visualBasic__keyword">New</span>&nbsp;Person(<span class="visualBasic__number">4</span>,&nbsp;<span class="visualBasic__string">&quot;代田橋　四朗&quot;</span>))&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;personData.Add(<span class="visualBasic__keyword">New</span>&nbsp;Person(<span class="visualBasic__number">5</span>,&nbsp;<span class="visualBasic__string">&quot;赤坂　五郎&quot;</span>))&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ComboBox1.ItemsSource&nbsp;=&nbsp;personData&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">End</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Public</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;<span class="visualBasic__keyword">New</span>(<span class="visualBasic__keyword">ByVal</span>&nbsp;id&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;<span class="visualBasic__keyword">Integer</span>,&nbsp;<span class="visualBasic__keyword">ByVal</span>&nbsp;name&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;<span class="visualBasic__keyword">String</span>)&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_id&nbsp;=&nbsp;id&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_name&nbsp;=&nbsp;name&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">End</span>&nbsp;<span class="visualBasic__keyword">Sub</span>&nbsp;
&nbsp;
...
<h2>実行結果</h2>
<p><img src="15609-image.png" alt=""></p>
<h2>ポイント</h2>
<p>コンボ ボックス上には、DisplayMemberPath プロパティに指定されたパスの項目 (今回は Name) が表示されており、選択されたオブジェクト自体 (上記の場合、Person オブジェクトそのもの) を取得する場合は SelectedItem プロパティで取得できます。</p>
<p>上記のサンプルでは、この SelectedItem の Name プロパティの値を TextBox にバインドしているため、コンボ ボックスで選択された項目の Name がテキスト ボックス上に反映されます。</p>
...
<p style="margin-top:20px"><a href="#top"><img src="15611-image.png" alt=""> ページのトップへ</a></p>
</div>
</div>
