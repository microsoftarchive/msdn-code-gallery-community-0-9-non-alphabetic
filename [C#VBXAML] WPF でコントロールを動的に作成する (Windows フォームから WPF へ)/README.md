# [C#/VB/XAML] WPF でコントロールを動的に作成する (Windows フォームから WPF へ)
## License
...
<p>ユーザー インターフェイスを作成するとき、表示する項目の数をあらかじめ決められない場合、あるいは状況によって異なるコントロールを使いたい場合に、コントロールを動的に作成することがあります。WPF のコントロールは、Windows フォームのコントロールと同じようにクラスのオブジェクト (インスタンス) であり、どちらも同じようにプログラムで動的に作成できます。その方法は&#20284;ていますが、WPF の特徴的な機能を利用するためには、いくらか拡張された手続きが必要です。</p>
<p>ここでは、プログラムで WPFの コントロールを作成する方法について解説します。</p>
<h2>Code [C#]</h2>
...
&nbsp;&nbsp;&nbsp;int counter = 0;<br>
<br>
&nbsp;&nbsp;&nbsp;private void btnNew_Click(object sender, RoutedEventArgs e)<br>
&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TextBox tbox = new TextBox();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.Width = 200;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.MouseEnter &#43;= new MouseEventHandler(tbox_MouseEnter);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.MouseLeave &#43;= new MouseEventHandler(tbox_MouseLeave);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.SetValue(Canvas.TopProperty, 30.0 * counter &#43; 40.0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.SetValue(Canvas.LeftProperty, 20.0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Binding bind = new Binding();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bind.ElementName = &quot;slider1&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bind.Path = new PropertyPath(Slider.ValueProperty);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.SetBinding(TextBox.TextProperty, bind);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;canvas1.Children.Add(tbox);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;counter&#43;&#43;;<br>
&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;void tbox_MouseEnter(object sender, MouseEventArgs e)<br>
&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TextBox tb = sender as TextBox;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tb.Background = SystemColors.HighlightBrush;<br>
&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;void tbox_MouseLeave(object sender, MouseEventArgs e)<br>
&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TextBox tb = sender as TextBox;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tb.Background = SystemColors.WindowBrush;<br>
&nbsp;&nbsp;&nbsp;}<br>
}</p>
</div>
<h2>Code [VB]</h2>
<div style="margin:0px 0px 20px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>Class MainWindow<br>
&nbsp;&nbsp;&nbsp;Dim counter As Integer = 0<br>
<br>
&nbsp;&nbsp;&nbsp;Private Sub btnNew_Click(ByVal sender As <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Object.aspx" target="_blank" title="Auto generated link to System.Object">System.Object</a>, ByVal e As <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Windows.RoutedEventArgs.aspx" target="_blank" title="Auto generated link to System.Windows.RoutedEventArgs">System.Windows.RoutedEventArgs</a>)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dim tbox As New TextBox()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.Width = 200<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AddHandler tbox.MouseEnter, AddressOf tbox_MouseEnter<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AddHandler tbox.MouseLeave, AddressOf tbox_MouseLeave<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.SetValue(Canvas.TopProperty, 30.0 * counter &#43; 40.0)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.SetValue(Canvas.LeftProperty, 20.0)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dim bind As New Binding()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bind.ElementName = &quot;slider1&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bind.Path = New PropertyPath(Slider.ValueProperty)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tbox.SetBinding(TextBox.TextProperty, bind)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;canvas1.Children.Add(tbox)<br>
...
&nbsp;&nbsp;&nbsp;End Sub<br>
<br>
&nbsp;&nbsp;&nbsp;Private Sub tbox_MouseEnter(ByVal sender As Object, ByVal e As MouseEventArgs)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dim tb As TextBox = CType(sender, TextBox)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tb.Background = SystemColors.HighlightBrush<br>
&nbsp;&nbsp;&nbsp;End Sub<br>
<br>
&nbsp;&nbsp;&nbsp;Private Sub tbox_MouseLeave(ByVal sender As Object, ByVal e As MouseEventArgs)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dim tb As TextBox = CType(sender, TextBox)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tb.Background = SystemColors.WindowBrush<br>
&nbsp;&nbsp;&nbsp;End Sub<br>
End Class</p>
...
&nbsp;&nbsp;&nbsp;&lt;Slider Name=&quot;slider1&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Canvas.Top=&quot;10&quot; Canvas.Left=&quot;20&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Width=&quot;200&quot; Minimum=&quot;0&quot; Maximum=&quot;100&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&lt;Button Name=&quot;btnNew&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Canvas.Top=&quot;10&quot; Canvas.Left=&quot;240&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Content=&quot;New TextBox&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Click=&quot;btnNew_Click&quot; /&gt;<br>
&nbsp;&lt;/Canvas&gt;<br>
&lt;/Window&gt;</p>
</div>
<h2 style="margin-top:30px">実行結果</h2>
<p><img src="15252-image.png" alt=""></p>
<h2 style="margin-top:30px">ポイント</h2>
<p>WPF のユーザー インターフェイスは、WPF デザイナーで編集したものが XAML による記述に反映されます。これに対し、Windows フォームでデザインしたものは C# や Visual Basic 言語によるプログラム コードに反映されます (&lt;フォーム名&gt;.Designer.cs または &lt;フォーム名&gt;.Designer.vb)。どちらの場合も、ウィンドウや配置するコントロールは、プログラミング言語における「オブジェクト」です。このため、WPF のコントロールを動的に作成することは、Windows
 フォームのコントロールの作成とほとんど同じです。</p>
<p>プロパティは代入文で設定でき、イベント ハンドラーは C# の場合は &#43;= 演算子、Visual Basic の場合はAddHandler 文で設定できます。上記の例では、プログラムで TextBox コントロールを作成し、Width プロパティに 200 を代入し、MouseEnter と MouseLeave イベントに、イベント ハンドラーを割り当てています。</p>
<p>WPF では、通常のプロパティだけでなく添付プロパティという仕組みがあります。上記の XAML では、Slider や Button の Canvas.Top や Canvas.Left は、Canvas パネルに配置したときにだけ使われる添付プロパティです。通常のプロパティがデータ メンバー (&lt;オブジェクト名&gt;.&lt;メンバー名&gt;) への代入で表現できるのに対して、添付プロパティへの代入や取得には SetValue メソッドや GetValue メソッドを使う必要があります。たとえば、slider1
 オブジェクトの添付プロパティ Canvas.Top を設定する場合には「slider1.SetValue(Canvas.TopProperty, 10.0)」のように記述します。ここで TopProperty とは、Canvas クラスで静的に定義されたプロパティ (依存関係プロパティ) です。プログラムで作成した TextBox コントロールも、Canvas.Top と Canvas.Left プロパティを設定して、表示位置を決めています。</p>
<p>また、WPF ではコントロールのプロパティどうしを連携するデータ バインディングという仕組みがあります。たとえば、上記の Slider (slider1) の Value プロパティと TextBox の Text プロパティを連携させるバインディングは、次のように記述できます。</p>
<div style="margin:0px 0px 20px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>&nbsp;&nbsp;&nbsp;&lt;TextBox Canvas.Top=&quot;40&quot; Canvas.Left=&quot;20&quot; Width=&quot;200&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Text=&quot;{Binding ElementName=slider1, Path=Value}&quot; /&gt;</p>
</div>
<p>この記述は、次のように書きなおすことができます。</p>
<div style="margin:0px 0px 20px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>&nbsp;&nbsp;&nbsp;&lt;TextBox Canvas.Top=&quot;40&quot; Canvas.Left=&quot;20&quot; Width=&quot;200&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBox.Text&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;Binding ElementName=&quot;slider1&quot; Path=&quot;Value&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/TextBox.Text&gt;<br>
&nbsp;&nbsp;&nbsp;&lt;/TextBox&gt;</p>
</div>
<p>ここで、TextBox や Binding のように、&lt;タグ&gt; ～ &lt;/タグ&gt; で囲まれた要素の定義は、プログラムにおけるオブジェクトの作成と同じです。これに対して TextBox.Text は TextBox の Text プロパティを割り当てるための記述です。つまり、Binding オブジェクトを作成してプロパティ (ElementName と Path) を割り当てたものを、TextBox の Text プロパティに設定することで、動的に作成したコントロールにもデータ バインディングが使えます
 (バインディングを指定するために SetBinding メソッドが用意されています)。上記のプログラムでは、この XAML の例と同じようなバインディングを割り当てています。</p>
<p>プログラムで生成したコントロールは、ウィンドウか他のコントロールに追加することで画面上に表示されます。上記の例では、Canvas の Children プロパティに追加しています。WPF では、コントロールを追加できるのはレイアウト パネルだけではありません。たとえば、Button や CheckBox など Content プロパティを持つコントロールは、その Content プロパティに 1 のコントロールを割り当てることができます。また、ListBox や ComboBox の Items プロパティには、Add
 メソッドを使って複数のコントロールを追加できます。このとき、レイアウト パネルもコントロールとして追加できるため、階層的にコントロールを追加することもできます。WPF では、すべての表示要素を Window あるいは UserControl をルートとしたツリー構造として定義します。</p>
<p>コントロールを動的に作成する際には、実行時までエラーが検出されにくいことに注意してください。特に添付プロパティで使う SetValue の第 2 引数は object 型であり、すべてのオブジェクトを受け取りますが、不正な型の値が渡されると実行時エラーになります。たとえば、Canvas.TopProperty や Canvas.LeftProperty はdouble 型の値が必要ですが、SetValue の第 2 引数に整数値を渡してもコンパイル時にはエラーになりません。このような場合は、オンライン
 ヘルプで各クラスの「アタッチされるプロパティ」を確認してください。</p>
