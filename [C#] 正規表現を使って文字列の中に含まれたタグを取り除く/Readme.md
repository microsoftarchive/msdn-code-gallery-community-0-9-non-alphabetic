...
<pre class="hidden"><code class="csharp">using System.Text.RegularExpressions;
using System;
...
<pre id="codePreview" class="csharp"><code class="csharp">using System.Text.RegularExpressions;
using System;
namespace Regex_Replace_CS
{
    class Program
