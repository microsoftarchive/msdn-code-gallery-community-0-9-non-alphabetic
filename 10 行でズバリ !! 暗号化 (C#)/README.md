...
<h2><img src="13139-image.png" alt=""> このコンテンツのポイント</h2>
<ul>
<li>.NET Framework の暗号モデルを理解する。 </li><li>Triple DES による暗号化を理解する。 </li></ul>
<h2><img src="13140-image.png" alt=""> 今回紹介するコード</h2>
...
<pre id="codePreview" class="csharp"><code class="csharp">private void button1_Click(object sender, EventArgs e)
{
	...
	textBox2.Text = Encoding.Unicode.GetString(cryptData);
}</code></pre>
</div>
</div>
...
<h3>目次</h3>
<p><a href="#encrypt_cs1">はじめに</a><br>
<a href="#encrypt_cs2">作成するアプリケーションの概要</a><br>
<a href="#encrypt_cs3">Windows フォーム アプリケーションの開発準備</a><br>
<a href="#encrypt_cs4">画面をデザインする</a><br>
<a href="#encrypt_cs5">コードを実装する</a><br>
<a href="#encrypt_cs6">実行する</a><br>
<a href="#encrypt_cs7">おわりに</a></p>
<table border="0" cellspacing="0" cellpadding="5" bgcolor="#e5f1f8">
<tbody>
<tr>
<td colspan="2" style="padding:5px 10px">Visual Basic の内容はこちらに掲載しています。</td>
</tr>
<tr>
<td align="center" style="padding:5px 5px 5px 10px"><img src="13142-image.png" alt=""></td>
<td style="padding:5px 10px 5px 0pt"><a href="/ja-jp/10-VB-9f669d2e">10 行でズバリ !! 暗号化 (VB)</a></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
<hr style="color:#b2c1e0">
<h2 id="encrypt_cs1">はじめに</h2>
<p>暗号化というと複雑なプログラミングを想像する方が多いかもしれませんが、.NET Framework の暗号モデルは、非常に使いやすく拡張性を持った構成になっているので、実装が非常に容易です。例えば対称アルゴリズムを実装するには、SymmetricAlgorithm から派生された、対称アルゴリズム向けのクラスを利用することで、全てのアルゴリズムにおいて同様のプログラミング モデルで暗号化処理を実装することができます。ここでは、対称アルゴリズムである Triple DES を使って、どのように暗号化を行うか解説します。</p>
<h2 id="encrypt_cs2">作成するアプリケーションの概要</h2>
<p>今回作成するのは、テキスト ボックスに入力された文字列を Triple DES により暗号化する Windows フォーム アプリケーションです。 Triple DES で暗号化するためには、あらかじめ対称アルゴリズムで利用する共有キーと初期化ベクタの準備が必要になります。これらの情報を厳密に管理するには、非対称アルゴリズムを利用して通信相手に送信することになりますが、ここでは、1 つのアプリケーションの中で暗号化と復号化を行いますので、アプリケーション起動時に生成し、それをそのまま復号処理でも利用します。</p>
<h2 id="encrypt_cs3">Windows フォーム アプリケーションの開発準備</h2>
<p>Visual Studio 2005 を起動して、新規にプロジェクトを作成します。</p>
<p>ここでは、Visual C# を選択し、「Windows アプリケーション」 テンプレートを選択します (図 1)。[プロジェクト名] ボックスに任意の名称を入力したら (ここでは CryptSampleCS)、 [OK] をクリックします。</p>
<p>これで 暗号化を行うアプリケーションの開発準備が完了しました。</p>
<p><img src="13143-image.png" alt=""></p>
<p><strong>図 1. 暗号化を行うためのプロジェクトを新規に作成する</strong></p>
<h2 id="encrypt_cs4">画面をデザインする</h2>
<p>フォームのデザインは、ドラッグ アンド ドロップという一貫性のある手順で行うことができます。Windows フォーム アプリケーションの基本的な作成方法については「<a href="http://msdn.microsoft.com/ja-jp/netframework/f86e71d0-7e86-4365-a63c-ee5a68d30346">10 行でズバリ !! Windows フォームによるクライアント アプリケーション開発</a>」をご参照ください。</p>
<p>既定で画面左側にある [ツールボックス] の [すべてのWindows フォーム] タブの中から、Button コントロールと、TextBox コントロールをそれぞれ図 2 のように配置します。</p>
<p><img src="13144-image.png" alt=""></p>
<p><strong>図 2. 画面上にコントロールを配置する</strong></p>
<h2 id="encrypt_cs5">コードを実装する</h2>
<p>using ディレクティブを使用して <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Security.Cryptography.aspx" target="_blank" title="Auto generated link to System.Security.Cryptography">System.Security.Cryptography</a>、および、<a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.IO.aspx" target="_blank" title="Auto generated link to System.IO">System.IO</a> の各名前空間の使用を宣言します。この宣言によって、名前空間の修飾を省いたクラス名の表記だけで、これら名前空間に属するクラスが使用可能になります。この記述を、Form1.cs の中の、他の using ディレクティブの次の行に記述します。</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<pre id="codePreview" class="csharp"><code class="csharp">using <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Security.Cryptography.aspx" target="_blank" title="Auto generated link to System.Security.Cryptography">System.Security.Cryptography</a>;
...
using <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Text.aspx" target="_blank" title="Auto generated link to System.Text">System.Text</a>;</code></pre>
</div>
</div>
<div class="endscriptcode">&nbsp;</div>
</div>
</div>
<p>次に、フォーム上の [暗号化] ボタンをダブルクリックし、textBox1 の文字列を暗号化する実装を記述します。</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<p>暗号化では、ストリームが利用されます。.NET Framework では各種媒体がストリームとして表現されているため、ストリームを利用することで、様々なデータ媒体に対してデータの暗号化を行うことができます。ここで は、データの媒体として、MemoryStream を使用しています。暗号化を直接行うのは、CryptoStream というストリームで、他のストリームと関連付けて使用します。また、対称アルゴリズム、ハッシュアルゴリズムで共通の CryptoStream を利用することで、より使いやすいインタフェースを提供します。</p>
<p>上記のコードでは、対称アルゴリズムの暗号化で利用する共通キー (DesKey 変数) と初期化ベクタ (DesIV 変数) は作成する実装はありません。本来ならば、共通キーと初期化ベクタを厳密に管理するために、セッション毎に共通キーと初期化ベクタを生成した後、非対称暗 号化方式を利用して通信相手に送信します。今回は 1 つのアプリケーションの中で復号化を行いますので、アプリケーションのメンバ変数として、共通キー、初期化ベクタを&#26684;納する変数を定義します。以下の 2 つの変数をメンバ変数 (フィールド) として定義するため、Form1
 クラスの中に記述します。また、暗号化されたデータの退避用に配列を用意します。</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<pre id="codePreview" class="csharp"><code class="csharp">private byte[] DesKey;
private byte[] DesIV;
private byte[] cryptData;</code></pre>
</div>
</div>
<div class="endscriptcode">&nbsp;</div>
</div>
</div>
<p>次に、初期処理としてコンストラクタ Form1の中に以下のコードを実装します。</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<pre id="codePreview" class="csharp"><code class="csharp">TripleDESCryptoServiceProvider TDES = new TripleDESCryptoServiceProvider();
DesKey = TDES.Key;
...
<p>対称アルゴリズムを利用した暗号化クラスでは、インスタンス生成時、常にキーと初期化ベクタが生成されます。このキーと初期化ベクタをメンバ変数として&#26684;納しておき、後から復号化の際にも利用できるようにします。</p>
...
{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">//&nbsp;cryptData&nbsp;配列から&nbsp;destination&nbsp;配列へ変換</span>&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">//&nbsp;Triple&nbsp;DES&nbsp;のサービス&nbsp;プロバイダを生成します</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;TripleDESCryptoServiceProvider&nbsp;des&nbsp;=&nbsp;<span class="cs__keyword">new</span>&nbsp;TripleDESCryptoServiceProvider();&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">//&nbsp;入出力用のストリームを生成します</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;MemoryStream&nbsp;ms&nbsp;=&nbsp;<span class="cs__keyword">new</span>&nbsp;MemoryStream();&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;CryptoStream&nbsp;cs&nbsp;=&nbsp;<span class="cs__keyword">new</span>&nbsp;CryptoStream(ms,&nbsp;des.CreateDecryptor(&nbsp;DesKey,&nbsp;DesIV&nbsp;),&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CryptoStreamMode.Write);&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">//&nbsp;ストリームに暗号化されたデータを書き込みます</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;cs.Write(cryptData,&nbsp;<span class="cs__number">0</span>,&nbsp;cryptData.Length);&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;cs.Close();&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">//&nbsp;復号化されたデータを&nbsp;byte&nbsp;配列で取得します</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__keyword">byte</span>[]&nbsp;destination&nbsp;=&nbsp;ms.ToArray();&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;ms.Close();&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;<span class="cs__com">//&nbsp;byte&nbsp;配列を文字列に変換して表示します</span>&nbsp;
...
<p>暗号化と復号化のそれぞれのイベント ハンドラの内容を比較すると、復号化と暗号化は全く同じプログラミング モデルになっていることが分かります。違いは、CryptoStream インスタンス生成時の第 2 引数で指定する変換処理の方法で、des オブジェクトの CreateEncryptor メソッドを CreateDecryptor メソッドに変更することで、復号化のコードを実装できます。</p>
<h2 id="encrypt_cs6">実行する</h2>
<p>コードの記述が完了したら、実行してみましょう。</p>
<p>アプリケーションを実行させるには [Ctrl&#43;F5] キーを押すか、[デバッグ] メニューの [デバッグなしで開始] をクリックします。上段のテキストボックスに適当な文字列を入力した後、[暗号化] ボタンをクリックすることで、上段の文字列が暗号化され、中段に表示されます。また、[復号化] ボタンをクリックすることで、中段の文字列が復号化され、下段に表示されます。</p>
<p><img src="13145-image.png" alt=""></p>
<p><strong>図 3. アプリケーションを実行し、暗号化と復号化を行う</strong></p>
<h2 id="encrypt_cs7">おわりに</h2>
<p>今回は、Triple DES による暗号化をご紹介しました。その他にも DES や RC2 などのアルゴリズムは全く同様のプログラミング モデルを採用していますので、今回の暗号化プロバイダの部分を変更するだけで、それらを利用することができます。非対称アルゴリズムとしては、DSA や RSA のアルゴリズムが同様に使いやすいプログラミング モデルで提供されています。これらを利用する際には、.NET Framework SDK の「暗号サービス」の記述を参考にして下さい。また、実際に暗号化を組み込む際に、非対称アルゴリズムと対称アルゴリズムを組み合わせて利用する場合も、「暗号サービス」の記述を参考にしてみて下さい。</p>
