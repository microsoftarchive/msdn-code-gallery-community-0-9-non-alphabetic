...
<p>using ディレクティブを使用して System.Security.Cryptography、および、System.IO の各名前空間の使用を宣言します。この宣言によって、名前空間の修飾を省いたクラス名の表記だけで、これら名前空間に属するクラスが使用可能になります。この記述を、Form1.cs の中の、他の using ディレクティブの次の行に記述します。</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">using System.Security.Cryptography;
using System.IO;
using System.Text;</code></pre>
<pre id="codePreview" class="csharp"><code class="csharp">using System.Security.Cryptography;
using System.IO;
using System.Text;</code></pre>
</div>
</div>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">private byte[] DesKey;
private byte[] DesIV;
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">TripleDESCryptoServiceProvider TDES = new TripleDESCryptoServiceProvider();
DesKey = TDES.Key;
