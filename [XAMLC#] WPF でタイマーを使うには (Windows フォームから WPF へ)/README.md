...
<hr>
<p>WPF でユーザー インターフェイスを定義する場合、Windows フォームにおける Timer コンポーネントのような「外観に影響しない」コントロールはありません。タイマーを使う場合は、DispatcherTimer というクラスを使います。</p>
<h2>Code [XAML]</h2>
<div style="margin:0px 0px 20px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>&lt;Window x:Class=&quot;WpfTimerApplication.MainWindow&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Title=&quot;MainWindow&quot; Height=&quot;300&quot; Width=&quot;400&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&lt;Grid&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- 時刻を表示するためのコントロール --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;TextBlock Name=&quot;text1&quot; FontSize=&quot;32&quot; Text=&quot;00:00:00&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&lt;/Grid&gt;<br>
&lt;/Window&gt;</p>
</div>
<h2>Code [C#]</h2>
<div style="margin:0px 0px 20px 0px; padding:10px 10px 3px 10px; background-color:#dedede">
<p>&hellip;&hellip;<br>
using <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Windows.Threading.aspx" target="_blank" title="Auto generated link to System.Windows.Threading">System.Windows.Threading</a>;<br>
<br>
public partial class MainWindow : Window<br>
{<br>
&nbsp;&nbsp;&nbsp;DispatcherTimer dispatcherTimer;<br>
<br>
&nbsp;&nbsp;&nbsp;public MainWindow()<br>
&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;InitializeComponent();<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dispatcherTimer = new DispatcherTimer(DispatcherPriority.Normal);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dispatcherTimer.Interval = new TimeSpan(0, 0, 1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dispatcherTimer.Tick &#43;= new EventHandler(dispatcherTimer_Tick);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dispatcherTimer.Start();<br>
&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;void dispatcherTimer_Tick(object sender, EventArgs e)<br>
&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;text1.Text = DateTime.Now.ToLongTimeString();<br>
&nbsp;&nbsp;&nbsp;}<br>
}</p>
</div>
<h2 style="margin-top:30px">実行結果</h2>
<p><img src="15584-image.png" alt=""></p>
<h2 style="margin-top:30px">ポイント</h2>
<p>タイマーの機能は、<a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Timers.aspx" target="_blank" title="Auto generated link to System.Timers">System.Timers</a> 名前空間で定義されている Timer クラスで実装されています (これは、Windows フォームに配置する <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Windows.Forms.Timer.aspx" target="_blank" title="Auto generated link to System.Windows.Forms.Timer">System.Windows.Forms.Timer</a> コンポーネントとは違うものです)。しかし、<a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Timers.Timer.aspx" target="_blank" title="Auto generated link to System.Timers.Timer">System.Timers.Timer</a> クラスはユーザー インターフェイスのためのスレッド (UI スレッド) とは独立したスレッドで実行されるため、イベント ハンドラーからユーザー インターフェイスを操作することができません。スレッド上のタスク管理のために
 Dispatcher というクラスが用意されており、WPF のユーザー インターフェイスには Dispatcher クラスのオブジェクトが関連づけられています。この Dispatcher オブジェクトと連携してユーザー インターフェイスを操作できるようにしたタイマーが DispatcherTimer クラスです。</p>
<p>このプログラムでは、メインウィンドウ (MainWindow) のコンストラクターで DispatcherTimer オブジェクトを作成して、タイマーとして使っています。DispatcherTimer を作成する際には、タイマーの優先順位を指定しています。優先順位は DispatcherPriority 列挙型であらわされるもので、優先順位の高いものから順に以下の表に示します。何も指定しない場合は、DispatcherPriority.Normal と同じです。</p>
<table class="grid" border="1" cellspacing="0" cellpadding="5" width="613" style="border-collapse:collapse; margin-bottom:10px">
<tbody>
<tr>
<td align="center" valign="middle" style="background-color:#4f81bd"><span style="color:#ffffff"><strong>メンバー名</strong></span></td>
<td width="60" align="center" valign="middle" style="background-color:#4f81bd"><span style="color:#ffffff"><strong>列挙値</strong></span></td>
<td align="center" valign="middle" style="background-color:#4f81bd"><span style="color:#ffffff"><strong>説明</strong></span></td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Send</strong></td>
<td align="center" valign="middle">10</td>
<td valign="top">操作は他の非同期操作の前に処理されます。これが最も高い優先順位です。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Normal</strong></td>
<td align="center" valign="middle">9</td>
<td valign="top">操作は通常の優先順位で処理されます。これが一般的なアプリケーションの優先順位です。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>DataBind</strong></td>
<td align="center" valign="middle">8</td>
<td valign="top">操作はデータ バインディングと同じ優先順位で処理されます。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Render</strong></td>
<td align="center" valign="middle">7</td>
<td valign="top">操作はレンダリングと同じ優先順位で処理されます。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Loaded</strong></td>
<td align="center" valign="middle">6</td>
<td valign="top">操作は、レイアウトとレンダリングが完了した後で、入力の優先順位の項目が処理される直前に処理されます。具体的には、これは、Loaded イベントを発生させるときに使用されます。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Input</strong></td>
<td align="center" valign="middle">5</td>
<td valign="top">操作は入力と同じ優先順位で処理されます。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Background</strong></td>
<td align="center" valign="middle">4</td>
<td valign="top">他のすべての非アイドル状態の操作が完了した後に操作が処理されます。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>ContextIdle</strong></td>
<td align="center" valign="middle">3</td>
<td valign="top">バックグラウンド操作が完了した後に操作が処理されます。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>ApplicationIdle</strong></td>
<td align="center" valign="middle">2</td>
<td valign="top">アプリケーションがアイドル状態のときに操作が処理されます。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>SystemIdle</strong></td>
<td align="center" valign="middle">1</td>
<td valign="top">システムがアイドル状態のときに操作が処理されます。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Inactive</strong></td>
<td align="center" valign="middle">0</td>
<td valign="top">操作は処理されません。</td>
</tr>
<tr>
<td align="center" valign="middle"><strong>Invalid</strong></td>
<td align="center" valign="middle">-1</td>
<td valign="top">これは無効な優先順位です。</td>
</tr>
</tbody>
</table>
<p>時間間隔は Interval プロパティで割り当てます。TimeSpan オブジェクトを生成する際には、引数によって意味が変わることに注意してください。Long 型の引数を 1 つ指定すると、100 ナノ秒単位の時間間隔を指定することになります。たとえば、1 秒を指定するときは「new TimeSpan (10000000)」または「new TimeSpan (0, 0, 1)」を指定します。Interval で指定した時間が経過すると Tick イベントが発生しますが、必ずしも正確な時間にイベントが発生するわけではありません。</p>
<p>DispatcherTimer クラスの詳細については「<a href="http://msdn.microsoft.com/ja-jp/library/ms615945.aspx" target="_blank">DispatcherTimer クラス</a>」を参照してください。</p>
