...
<pre class="hidden"><code class="csharp">Dim data() As Variant</code></pre>
...
<span class="hidden">vb</span>
<pre class="hidden">Set result1 = obj.Item(10)
Set result2 = obj.Item(&quot;Sunday&quot;)</pre>
...
<div class="pluginEditHolderLink">{#scriptcode_dlg.edit_script}</div>
<span class="hidden">vb</span>
<pre class="hidden">Public Property Get Item(ndx As Variant) As Class1
...
<div class="pluginEditHolderLink">{#scriptcode_dlg.edit_script}</div>
<span class="hidden">vb</span>
<pre class="hidden">Public Overloads ReadOnly Property Item(ByVal ndx As Intger) As Class1
    Get
        :(省略)
    End Get
End Property
 
Public Overloads ReadOnly Property Item(ByVal ndx As String) As Class1
    Get
        :(省略)
    End Get
End Property</pre>
...
<div class="pluginEditHolderLink">{#scriptcode_dlg.edit_script}</div>
<span class="hidden">vb</span>
<pre class="hidden">Public Sub Process(odr As Variant)
    odr.MakeSummary
    odr.Flag = 1
End Sub</pre>
...
<div class="pluginEditHolderLink">{#scriptcode_dlg.edit_script}</div>
<span class="hidden">vb</span>
<pre class="hidden">Public Interface IOrder
    Sub MakeSummary()
...
<div class="pluginEditHolderLink">{#scriptcode_dlg.edit_script}</div>
<span class="hidden">vb</span>
<pre class="hidden">Public Class MyOrder
    Implements IOrder
