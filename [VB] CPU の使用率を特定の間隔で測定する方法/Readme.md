...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">pc As New PerformanceCounter(&quot;Processor&quot;, &quot;% Processor Time&quot;, &quot;_Total&quot;, True)</code></pre>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">For Each category In PerformanceCounterCategory.GetCategories()
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Dim tDelegate As New Threading.TimerCallback(AddressOf GetCpuUsage)</code></pre>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Sub GetCpuUsage(ByVal state As Object)
    Dim pc As PerformanceCounter = CType(state, PerformanceCounter)
    If pc IsNot Nothing Then
        Console.WriteLine(String.Format(&quot;現在のCPU使用率は {0:f}% です。&quot;, pc.NextValue()))
    End If
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">oTimer As New Timer(tDelegate, pc, 0, 1000)</code></pre>
