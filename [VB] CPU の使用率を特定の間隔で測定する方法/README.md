...
<pre id="codePreview" class="vb"><code class="csharp">Imports <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Threading.aspx" target="_blank" title="Auto generated link to System.Threading">System.Threading</a>
...
<pre id="codePreview" class="vb"><code class="csharp">pc As New PerformanceCounter(&quot;Processor&quot;, &quot;% Processor Time&quot;, &quot;_Total&quot;, True)</code></pre>
</div>
</div>
<div class="endscriptcode">&nbsp;</div>
</div>
...
<pre id="codePreview" class="vb"><code class="csharp">For Each category In PerformanceCounterCategory.GetCategories()
...
<pre id="codePreview" class="vb"><code class="csharp">Dim tDelegate As New Threading.TimerCallback(AddressOf GetCpuUsage)</code></pre>
</div>
</div>
<div class="endscriptcode">&nbsp;</div>
</div>
...
<pre id="codePreview" class="vb"><code class="csharp">Sub GetCpuUsage(ByVal state As Object)
    Dim pc As PerformanceCounter = CType(state, PerformanceCounter)
    If pc IsNot Nothing Then
        Console.WriteLine(String.Format(&quot;現在のCPU使用率は {0:f}% です。&quot;, pc.NextValue()))
    End If
...
<pre id="codePreview" class="vb"><code class="csharp">oTimer As New Timer(tDelegate, pc, 0, 1000)</code></pre>
</div>
</div>
<div class="endscriptcode">&nbsp;</div>
</div>
...
Module Module1
    ...
    Sub Main()
        Try
            Using sTimer As New <a class="libraryLink" href="http://msdn.microsoft.com/ja-JP/library/System.Timers.Timer.aspx" target="_blank" title="Auto generated link to System.Timers.Timer">System.Timers.Timer</a>(1000)
