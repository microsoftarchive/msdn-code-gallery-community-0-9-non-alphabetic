...
<pre class="hidden"><code class="csharp">Dim col As New MyCollection()
col.Add(100)
col.Add(200)
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Public Class MyCollection		&larr;[1]
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Dim col1 As New MyCollection()			&larr;[1]
