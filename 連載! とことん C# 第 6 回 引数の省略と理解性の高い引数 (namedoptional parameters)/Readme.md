...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">A.WriteIt(writer: Console.Out, obj: &quot;a girl&quot;);</code></pre>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">A.WriteIt(obj: &quot;a girl&quot;, writer: Console.Out);</code></pre>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">A.WriteIt(Console.Out, obj: &quot;a girl&quot;);</code></pre>
...
<p>例えば、その一例は Microsoft Excel です。引数を省略しないで書くとすれば、かなり冗長になります。以下は、Excel のブックを開く例です。(なお実行に際しては、Microsoft Office 相互運用機能の Microsoft.Office.Interop.Excel の参照を追加し、sample.xlsx というファイルが存在していると仮定します。)</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">excel.Workbooks.Open(@&quot;C:\sample.xlsx&quot;);</code></pre>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">private static void a(MyClass p = new MyClass(&quot;匿名希望&quot;))
    {
        Console.WriteLine(&quot;名前は{0}です。&quot;, p.Name);
    }</code></pre>
