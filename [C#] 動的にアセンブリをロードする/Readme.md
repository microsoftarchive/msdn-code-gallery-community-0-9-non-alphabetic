...
<h2 style="font-size:100%">MyLibrary.cs</h2>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">Assembly asm = Assembly.Load(&quot;MyLibrary&quot;);
Type myType = asm.GetType(&quot;MyLibrary.MyBirthday&quot;);
MethodInfo myMethod = myType.GetMethod(&quot;CalcDaysFromBirthDate&quot;);</code></pre>
<pre id="codePreview" class="csharp"><code class="csharp">Assembly asm = Assembly.Load(&quot;MyLibrary&quot;);
Type myType = asm.GetType(&quot;MyLibrary.MyBirthday&quot;);
MethodInfo myMethod = myType.GetMethod(&quot;CalcDaysFromBirthDate&quot;);</code></pre>
</div>
</div>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">object obj = Activator.CreateInstance(myType);
myMethod.Invoke(obj, new object[] { birthDate });</code></pre>
<pre id="codePreview" class="csharp"><code class="csharp">object obj = Activator.CreateInstance(myType);
myMethod.Invoke(obj, new object[] { birthDate });</code></pre>
</div>
</div>
<div class="endscriptcode">&nbsp;</div>
...
<pre id="codePreview" class="csharp"><code class="csharp">誕生日を入力してください(yyyy/MM/dd):1978/08/13
あなたの誕生日は 1978/08/13 です。誕生日から 11608 日経過しています。</code></pre>
</div>
</div>
<div class="endscriptcode">&nbsp;</div>
...
<p>動的にロードする場合に有益なリフレクションの用法、さらに C# 4.0 で追加された dynamic 型を使用したアセンブリの動的ロード、応用例については、<a href="http://msdn.microsoft.com/ja-jp/ff357685.aspx">連載! とことん C#</a> の</p>
<ul>
<li><a href="http://msdn.microsoft.com/ja-jp/ff521865.aspx">第 16 回 リフレクション (Reflection) を活用する</a>
</li><li><a href="http://msdn.microsoft.com/ja-jp/ff602856.aspx">第 17 回 動的にアセンブリをロードする</a>
</li></ul>
<p>に解説がされていますので、こちらも確認してください。</p>
<h3>関連リンク</h3>
<ul>
...
<hr>
<p><a href="http://go.microsoft.com/?linkid=9759323" style="margin-top:3px">&nbsp;</a></p>
<table>
<tbody>
<tr>
