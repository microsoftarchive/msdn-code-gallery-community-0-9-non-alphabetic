...
<p>C 言語などの列挙型は単なる定数定義でしかありませんが、上記の動作からわかるように、C# では違っています。列挙型を扱う機能は、System.Enum クラスに含まれます。これを使うことで、特定の列挙型に含まれる値の一覧なども容易に得ることができます (下記)。</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<p>この場合、属性 (System.Reflection.ObfuscationAttribute) などを使って難読化の対象外とするか、列挙型の名前は判断のみに使用し、出力には使用しない配慮などが必要です。(「属性」については、<a href="http://msdn.microsoft.com/ja-jp/ff458236.aspx">「第 14 回 属性 (Attribute) の使用」</a>を参照してください。)</p>
