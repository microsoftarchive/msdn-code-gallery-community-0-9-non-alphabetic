...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">namespace A
{
    namespace B
    {
        class X { }
...
<p>前述の例のように名前空間を常に明示すると、当然、ソース コードが長くなります。そこで、ソース コードでよく見かける using ディレクティブを使って名前を短縮する行為が行われます。よくサンプル コードに出てくる Console.WriteLine は、本来なら System.Console.WriteLine ですが、先頭にある using System のおかげで System 名前空間を省略できます。</p>
...
<p>名前の別名は、名前空間やクラスの名前に別名を付けることができる仕組みです。以下は、System.Console に C という別名を付けて使用した例です。つまり、別の短い名前に別名を付けてしまうことで、「同じ名前の衝突を防ぐ」、「短く書く」という 2 つの目的を同時に満たせます。(下記のように、名前空間だけでなく、クラス自体にも別名が適用できます。)</p>
<div class="CodeHighlighter">
<div style="clear:both">
<div class="scriptcode">
<div class="pluginEditHolder" pluginCommand="mceScriptCode">
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">using C = System.Console;
...
<pre id="codePreview" class="csharp"><code class="csharp">using C = System.Console;
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">extern alias Lib1;
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">Lib1::ClassLibrary.Class.SayHello(); // 出力：in ClassLibrary1!
