...
<style><!-- ﻿.showRatings{border-bottom:silver 1px solid;background-color:#f0f0f0;text-align:left;width:100%;height:28px;vertical-align:bottom;}.showRatings_right{z-index:99;float:right;} ﻿.CodeHighlighter{word-wrap:break-word;}pre{white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:o-pre-wrap;}
 ...
 ﻿#BodyBackground{background:#fff url('../images/logos_and_bg.png') repeat-x 0 -100px;}#JelloWrapper{background:url('../images/bg_branding_msdn_windows.jpg') no-repeat center top;}.BrandLogo a{background:url('../images/logos_and_bg.png') no-repeat 0 -23px;display:block;height:27px;margin-top:-2px;width:156px;}.BrandLogo
 span{display:none;}.BrandLogo,.BrandLogo a,.BrandLogo a:link,.BrandLogo a:visited,.BrandLogo a:hover,.BrandLogo a:active,.GlobalBar,.PassportScarab,.PassportScarab a,.PassportScarab a:link,.PassportScarab a:visited,.PassportScarab a:hover,.PassportScarab a:active,.UserName,.UserName
 a,.UserName a:link,.UserName a:visited,.UserName a:hover,.UserName a:active,a.LocaleManagementFlyoutStaticLink,a:link.LocaleManagementFlyoutStaticLink,a:visited.LocaleManagementFlyoutStaticLink,a:hover.LocaleManagementFlyoutStaticLink,a:active.LocaleManagementFlyoutStaticLink{color:#000;}.NetworkLogo
 a{background:url('../images/logos_and_bg.png') no-repeat 0 0;}.leftcap{background:url('../images/tabstrip.png') no-repeat -1002px 0;}.rightcap{background:url('../images/tabstrip.png') no-repeat right top;}.internav{background:url('../images/tabstrip.png')
 no-repeat right top;}.internav a,.internav a:link,.internav a:visited,.internav a:hover{color:#fff;}.internav a:hover{background-color:#046ea0;}.internav a.active,.internav a.active:link,.internav a.active:hover,.internav a.active:visited,.internav a.active:active{background-color:#297f02;color:#fff;}.LocalNavigation{background:url('../images/tabstrip.png')
 repeat-y left top;}.LocalNavigation .TabOn,.LocalNavigation .TabOn:hover{background-color:#046ea0;}.LocalNavigation .TabOn a,.LocalNavigation .TabOn a:hover,.LocalNavigation .TabOn a:visited{color:#fff;}.LocalNavigation .TabOff a{color:#fff;}.LocalNavigation
 .TabOff a:hover{background-color:#0281bd;}.BostonPostCard h1,.BostonPostCard h2,.BostonPostCard h3,.BostonPostCard h4,.BostonPostCard h5,.BostonPostCard h6{background-color:#297f02;color:#3a3e43;}.BostonPostCard h1 a,.BostonPostCard h2 a,.BostonPostCard h3
 a,.BostonPostCard h4 a,.BostonPostCard h5 a,.BostonPostCard h6 a{color:#3a3e43;}.RightAdRail .BostonPostCard h1,.RightAdRail .BostonPostCard h2,.RightAdRail .BostonPostCard h5{background-color:#297f02;color:#3a3e43;}.RightAdRail .BostonPostCard h3,.RightAdRail
 .BostonPostCard h4,.RightAdRail .BostonPostCard h6{background-color:#7d7d7d;color:#fff;}.FullWidth .h3,.fullwidth .h3,.MainColumn .h3,.maincolumn .h3,.MiddleColumn .h3,.middlecolumn .h3,.RightColumn .h3,.rightcolumn .h3,.ColumnFifty .h3,.columnfifty .h3{background-color:#297f02!important;}.top1,.boxheader{background:#7d7d7d;color:#fff!important;}.boxcontent{border-bottom:1px
 solid #7d7d7d!important;border-left:1px solid #7d7d7d!important;border-right:1px solid #7d7d7d!important;} body{font-family:Verdana,Arial,Helvetica,sans-serif;color:#000;font-size:68.75%}a{text-decoration:none;color:#03c}a:link{color:#03c}a:visited{color:#800080}a:hover{color:#f60}a:active{color:#800080}a
...
<p>動作確認環境: .NET Framework 4, Visual Studio 2010, Windows 7</p>
<p>更新日: 2010 年 2 月 26 日</p>
<hr>
<p>WPF 4 を用いて Windows 7 のマルチタッチに対応したアプリケーションを作成する際に、TouchDown や TouchMove、TouchUp などの基本的なタッチ操作に係るイベントを使用する代わりに、ManipulationDelta イベントなどのある程度まとまった操作 (manipulation) に係るイベントを使用することで、移動や拡大/縮小、回転などの処理を簡潔に実装することができます。</p>
<p>ここで取り上げるサンプル アプリケーションでは、次の図に示す青い四角形を 2 本指でタッチして、移動や拡大/縮小、回転を行う方法を説明します。</p>
<p><strong>図 1. 青色の四角形に対して 2 本指でタッチして、移動や拡大/縮小、回転を行う</strong></p>
<p><img src="15726-image.png" alt=""></p>
<p>次に、上記のアプリケーションのコードを示します。(次のコードは、Visual Studio 2010 で作成した WPF アプリケーションに追加することを前提にしています。)</p>
<p><strong>例 1. Visual Basic (MainWindow.xaml)</strong></p>
...
<pre class="hidden">&lt;Window x:Class=&quot;MainWindow&quot;
    ...
    &lt;Canvas&gt;
        &lt;Rectangle Fill=&quot;Blue&quot; Width=&quot;200&quot; Height=&quot;200&quot;	&larr;[1]
                 IsManipulationEnabled=&quot;True&quot;&gt;			&larr;[2]
            &lt;Rectangle.RenderTransform&gt;				&larr;[3]
                &lt;MatrixTransform&gt;
...
&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">Title</span>=<span class="xaml__attr_value">&quot;MainWindow&quot;</span>&nbsp;<span class="xaml__attr_name">Height</span>=<span class="xaml__attr_value">&quot;600&quot;</span>&nbsp;<span class="xaml__attr_name">Width</span>=<span class="xaml__attr_value">&quot;800&quot;</span><span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;Canvas</span><span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;Rectangle</span>&nbsp;<span class="xaml__attr_name">Fill</span>=<span class="xaml__attr_value">&quot;Blue&quot;</span>&nbsp;<span class="xaml__attr_name">Width</span>=<span class="xaml__attr_value">&quot;200&quot;</span>&nbsp;<span class="xaml__attr_name">Height</span>=<span class="xaml__attr_value">&quot;200&quot;</span>&nbsp;&nbsp;&nbsp;&nbsp;&larr;[1]&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__attr_name">IsManipulationEnabled</span>=<span class="xaml__attr_value">&quot;True&quot;</span><span class="xaml__tag_start">&gt;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&larr;[2]&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;Rectangle</span>.RenderTransform<span class="xaml__tag_start">&gt;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&larr;[3]&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;MatrixTransform</span><span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;MatrixTransform</span>.Matrix<span class="xaml__tag_start">&gt;&nbsp;
</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_start">&lt;Matrix</span>&nbsp;<span class="xaml__attr_name">OffsetX</span>=<span class="xaml__attr_value">&quot;200&quot;</span>&nbsp;<span class="xaml__attr_name">OffsetY</span>=<span class="xaml__attr_value">&quot;200&quot;</span><span class="xaml__tag_start">/&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/MatrixTransform.Matrix&gt;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="xaml__tag_end">&lt;/MatrixTransform&gt;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/Rectangle.RenderTransform&gt;&nbsp;
...
<pre class="hidden"><code class="csharp">Private Sub Window_ManipulationStarting(ByVal sender As System.Object, ByVal e As System.Windows.Input.ManipulationStartingEventArgs) Handles MyBase.ManipulationStarting	&larr;[4]


    e.ManipulationContainer = Me		&larr;[5]
    e.Handled = True				&larr;[6]


End Sub


Private Sub Window_ManipulationDelta(ByVal sender As System.Object, ByVal e As System.Windows.Input.ManipulationDeltaEventArgs) Handles MyBase.ManipulationDelt  &larr;[7]


    Dim rect = TryCast(e.OriginalSource, Rectangle)				&larr;[8]
    Dim rectsMatrix = (CType(rect.RenderTransform, MatrixTransform)).Matrix	&larr;[9]


    rectsMatrix.RotateAt(e.DeltaManipulation.Rotation,	&larr;[10]
    ...
    rect.RenderTransform = New MatrixTransform(rectsMatrix)	&larr;[11]
...
End Sub</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Private Sub Window_ManipulationStarting(ByVal sender As System.Object, ByVal e As System.Windows.Input.ManipulationStartingEventArgs) Handles MyBase.ManipulationStarting	&larr;[4]
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">xaml</span>
<pre class="hidden"><code class="csharp">&lt;Window x:Class=&quot;Sample11cs.MainWindow&quot;
        xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
        xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
        Title=&quot;MainWindow&quot; Height=&quot;600&quot; Width=&quot;800&quot; 
    ...
    &lt;/Canvas&gt;
&lt;/Window&gt;</code></pre>
<pre id="codePreview" class="xaml"><code class="csharp">&lt;Window x:Class=&quot;Sample11cs.MainWindow&quot;
        xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
        xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
        Title=&quot;MainWindow&quot; Height=&quot;600&quot; Width=&quot;800&quot; 
        ManipulationStarting=&quot;Window_ManipulationStarting&quot;
...
<pre class="hidden">private void Window_ManipulationStarting(object sender,	&larr;[4]
                                             ManipulationStartingEventArgs e)
{
    e.ManipulationContainer = this;		&larr;[5]
    e.Handled = true;				&larr;[6]
}


private void Window_ManipulationDelta(object sender, 		&larr;[7]
                                         ManipulationDeltaEventArgs e)
{
    Rectangle rect = e.OriginalSource as Rectangle;				&larr;[8]
    Matrix rectsMatrix = ((MatrixTransform)rect.RenderTransform).Matrix;	&larr;[9]
...
<pre class="csharp"><span class="cs__keyword">private</span>&nbsp;<span class="cs__keyword">void</span>&nbsp;Window_ManipulationStarting(<span class="cs__keyword">object</span>&nbsp;sender,&nbsp;&nbsp;&nbsp;&nbsp;&larr;[<span class="cs__number">4</span>]&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ManipulationStartingEventArgs&nbsp;e)&nbsp;
{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;e.ManipulationContainer&nbsp;=&nbsp;<span class="cs__keyword">this</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&larr;[<span class="cs__number">5</span>]&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;e.Handled&nbsp;=&nbsp;<span class="cs__keyword">true</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&larr;[<span class="cs__number">6</span>]&nbsp;
}&nbsp;
&nbsp;
&nbsp;
<span class="cs__keyword">private</span>&nbsp;<span class="cs__keyword">void</span>&nbsp;Window_ManipulationDelta(<span class="cs__keyword">object</span>&nbsp;sender,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&larr;[<span class="cs__number">7</span>]&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ManipulationDeltaEventArgs&nbsp;e)&nbsp;
{&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;Rectangle&nbsp;rect&nbsp;=&nbsp;e.OriginalSource&nbsp;<span class="cs__keyword">as</span>&nbsp;Rectangle;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&larr;[<span class="cs__number">8</span>]&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;Matrix&nbsp;rectsMatrix&nbsp;=&nbsp;((MatrixTransform)rect.RenderTransform).Matrix;&nbsp;&nbsp;&nbsp;&nbsp;&larr;[<span class="cs__number">9</span>]&nbsp;
&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;rectsMatrix.RotateAt(e.DeltaManipulation.Rotation,&nbsp;&nbsp;&nbsp;&nbsp;&larr;[<span class="cs__number">10</span>]&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;e.ManipulationOrigin.X,&nbsp;e.ManipulationOrigin.Y);&nbsp;
&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;rectsMatrix.ScaleAt(e.DeltaManipulation.Scale.X,&nbsp;e.DeltaManipulation.Scale.X,&nbsp;
...
&nbsp;
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;rect.RenderTransform&nbsp;=&nbsp;<span class="cs__keyword">new</span>&nbsp;MatrixTransform(rectsMatrix);&nbsp;&nbsp;&nbsp;&nbsp;&larr;[<span class="cs__number">11</span>]&nbsp;
&nbsp;
&nbsp;
...
<p>このサンプルでは、ウィンドウのクライアント領域全体をキャンバス (Canvas) が占めており、その中に [1] の Regtangle オブジェクトが配置されています。この Regtangle (四角形) がタッチ操作によって変化します。[3] の RenderTransform プロパティには、この Regtangle の初期値として MatrixTransform オブジェクトが指定されており、コンテナー内の相対位置として、左辺および上部から 200 ピクセルずれた位置に表示されます。タッチ操作のイベントに応じて、この
 RenderTransform プロパティの値を変化させることで、この四角形が変化します。</p>
<p>また、ここで扱う拡大/縮小、回転などの操作 (manipulation) に係るイベントを、特定のコントロールの上で捕捉するには、対象となる要素の IsManipulationEnabled プロパティを &quot;True&quot; に設定する必要があり、この例でも [2] で Rectangle オブジェクトの同プロパティを &quot;True&quot; に設定しています。</p>
<p>最低限必要となるイベント ハンドラーは、[4] の ManipulationStarting イベント ハンドラーと [7] の ManipulationDelta イベント ハンドラーです。[4] の ManipulationStarting イベントは、拡大操作や回転操作などの 1 つ分の操作の初めに、1 回だけ発生します。一方、[7] の ManipulationDelta イベントは、拡大操作や回転操作などの 1 つ分の操作の中で、刻々と図形を変化すべきタイミングで継続的に複数回発生します。</p>
<p>[4] のイベント ハンドラーの中にある [5] の ManipulationContainer プロパティでは、これ以降で発生する [7] のイベントにおいて、どのコントロールを基準にした相対座標を使用するかを指定します。ここでは Me (this) を指定しているので、ウィンドウを基準にした相対座標になります。また [6] の設定は、タッチ操作固有のものではなく、WPF の仕組みであるイベントのルーティングにおいて、これより上位のコンテナーにイベントを送らなくするためのものです。</p>
<p>[7] では、第 2 引数 e に変化すべき図形の位置やサイズ、回転に関する情報が渡ってくるので、その情報を元に Regtangle を変形させます。[8] で対象となる Rectangle オブジェクトの参照を求めた後、[9] では Rectangle の RenderTransform プロパティから、位置やサイズを管理する Matrix オブジェクトを取り出し、[10] 以降では、回転、サイズ変更、および移動を行います。これらは、順に RotateAt メソッド、ScaleAt メソッド、および
 Translate メソッドの呼び出しによって行い、これらのメソッドの引数にはイベント ハンドラーの第 2 引数 e に渡された回転や倍率、位置に関する情報を使用します。一通り Matrix オブジェクトへの変更が済んだら、[11] では Matrix オブジェクトから MatrixTransform オブジェクトを作成し、RectangleのRenderTransform プロパティに設定します。この設定に基づいて、この四角形は移動され、変形されます。</p>
<div style="margin:10px 0; padding:10px 10px 0 10px; background-color:#efefef; border:solid 1px #333333">
<p><strong>Note:</strong> ここでは簡単にするため、移動、拡大/縮小、および回転に焦点を当てコードを簡潔に記述しました。実際は、このほかに「慣性」(Inertia) を考慮する必要があります。たとえば現時点のこのサンプルでは、勢いを付けて指で図形を振り払うと、慣性を得て図形がウィンドウから飛び出してしまい、それ以上操作できなくなります。よって、勢いが付いてもウィンドウの外に飛び出さないようなロジックが必要です。詳細は「<a href="http://msdn.microsoft.com/ja-jp/windows/ff428400.aspx">WPF
 4 を使用して、マルチタッチの操作による慣性 (Inertia) に対応する</a>」を参照してください。</p>
</div>
