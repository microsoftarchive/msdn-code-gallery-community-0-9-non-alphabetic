...
<pre class="hidden"><code class="csharp">protected void Button1_Click(object sender, EventArgs e)
{
    ...
    Label1.BackColor = System.Drawing.Color.FromName(colorName);
}</code></pre>
...
<strong>using System.Configuration;<br>
&nbsp;</strong><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Label1.BackColor = System.Drawing.Color.FromName(colorName);<br>
&nbsp;&nbsp;&nbsp;}</strong><br>
}</p>
</div>
<p>ConfigurationManager は構成ファイルの情報を管理するためのクラスです。このクラスの AppSettings メンバーは連想配列になっており、指定したキー文字列に対応する値文字列を返します。戻り値は常に文字列型です。したがって、ASP.NET の要素として「BackColor=&quot;Yellow&quot;」のように指定する場合でも、プログラムではプロパティの型に合わせた値 (BackColor の場合は、System.Drawing.Color 型) に変換する必要があります。</p>
