...
<pre id="codePreview" class="xaml"><code class="csharp">&lt;Window x:Class=&quot;TextBlock_WPF03.Window1&quot;
    xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
    xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
    Title=&quot;Window1&quot; Height=&quot;600&quot; Width=&quot;400&quot;&gt;
    &lt;StackPanel x:Name=&quot;LayoutRoot&quot;&gt;

        &lt;!--テキストの折り返し指定はTextWrappingプロパティで行う--&gt;
        &lt;TextBlock TextWrapping=&quot;Wrap&quot;&gt;
            Windows Presentation Foundation TextBlock Wrapping Text Demonstration.
        &lt;/TextBlock&gt;

        &lt;!--折り返さなければ行端でトリミングされて表示--&gt;
        ...
        &lt;!--折り返しの行送り高さは既定では各行の最大高さに最適化されている--&gt;
        &lt;TextBlock TextWrapping=&quot;Wrap&quot;&gt;
            &lt;Run FontSize=&quot;20&quot;&gt;Windows Presentation Foundation&lt;/Run&gt;
            &lt;Run FontSize=&quot;40&quot;&gt;TextBlock &lt;/Run&gt;
            &lt;Run FontSize=&quot;30&quot;&gt;Wrapping Text&lt;/Run&gt;
            &lt;Run FontSize=&quot;10&quot;&gt;Demonstration.&lt;/Run&gt;
        &lt;/TextBlock&gt;

        &lt;!--折り返しの行送りを一定にするには
          LineStackingStrategyプロパティとLineHeightプロパティを設定する--&gt;
...
<h2>実行結果</h2>
<p><img src="15677-image.png" alt=""></p>
<h2>ポイント</h2>
<p>TextBlock で折り返し表示を行うには TextWrapping プロパティを指定することで折り返し設定が行えます。</p>
<p>TextWrapping プロパティは既定では折り返しを行わない「NoWrap」が指定されており、「Wrap」に設定すると行端で折り返し表示を行うようになります。</p>
<p>TextWrapping プロパティを既定もしくは NoWrap を指定すると行末で文字列のトリミングが行われます。</p>
<p>TextTrimming プロパティを指定することで行末のトリミング方法について指定することが可能です。TextTrimming プロパティは既定では行末でトリミングを行うだけの None、行末になると、その後続の文字列の存在を表現する省略記号「&hellip;」を表示する CharacterEllipsis、同じく行末の最後の単語の後に省略記号を表示する WordEllipsis の 3 種類が指定できます。</p>
<p>また、TextBlock コントロールでは既定で各行に表示されているフォントサイズ等を考慮し自動的に行送り高さを最適化するように設定されています。この行送り幅を調整するには LineStackingStrategy プロパティと LineHeight プロパティを使用します。</p>
<p>LineStackingStartegy プロパティは行送り幅を各行の MaxHeight に調整するか、それとも指定された LineHeight プロパティ値にする (BlockLineHeight) 選択します。</p>
<p>LineHeight プロパティは LineStackingStrategy プロパティが BlockLineHeight を指定されたら設定値が有効になります。また、LineHeight プロパティの規定値は NaN (Auto 相当) となっており、各行の FontSize などを考慮した MaxHeight になるように設定されています。</p>
