...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)_
                                                                 Handles Base.Load
    ...
    End Select
End Sub</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)_
                                                                 Handles Base.Load
    Select Case Request.QueryString(&quot;state&quot;)
        Case &quot;1&quot;
            'クエリ文字列が、state = 1 の時は、Cookie 変数からデータを取得
...
<hr>
<h2 id="page_datapass_vb-1">はじめに</h2>
...
<p><img src="14714-image.png" alt=""></p>
