# 10 行でズバリ!!SharePoint の Web パーツ作成とデータ アクセス(C#)
## Requires
- 
## License
...
<style><!-- ﻿.showRatings{border-bottom:silver 1px solid;background-color:#f0f0f0;text-align:left;width:100%;height:28px;vertical-align:bottom;}.showRatings_right{z-index:99;float:right;} ﻿.ShareThisMainPanel{text-align:left;float:left;}.ShareThis_RootButton{cursor:pointer;border:solid
 ...
 h1{line-height:130%;}.BostonPostCard h6{font-size:95%;line-height:120%;padding:0 0 1px 0;} ﻿#BodyBackground{background:#fff url('../images/logos_and_bg.png') repeat-x 0 -100px;}#JelloWrapper{background:url('../images/bg_branding_msdn_sharepoint.jpg') no-repeat
 right top;}.BrandLogo a{background:url('../images/logos_and_bg.png') no-repeat 0 -23px;display:block;height:42px;margin-top:-11px;width:164px;}.BrandLogo span{display:none;}.BrandLogo,.BrandLogo a,.BrandLogo a:link,.BrandLogo a:visited,.BrandLogo a:hover,.BrandLogo
 ...
 right top;}.internav a,.internav a:link,.internav a:visited,.internav a:hover{color:#313131;}.internav a:hover{background-color:#d1d1d1;}.internav a.active,.internav a.active:link,.internav a.active:hover,.internav a.active:visited,.internav a.active:active{background-color:#333;color:#fff;}.LocalNavigation{background:url('../images/tabstrip.png')
 repeat-y left top;}.LocalNavigation .TabOn,.LocalNavigation .TabOn:hover{background-color:#e1e1e1;}.LocalNavigation .TabOn a,.LocalNavigation .TabOn a:hover,.LocalNavigation .TabOn a:visited{color:#313131;}.LocalNavigation .TabOff a{color:#fff;}.LocalNavigation
 .TabOff a:hover{background-color:#333;}.BostonPostCard h1,.BostonPostCard h2,.BostonPostCard h3,.BostonPostCard h4,.BostonPostCard h5,.BostonPostCard h6{background-color:#ffc845;color:#3a3e43;}.BostonPostCard h1 a,.BostonPostCard h2 a,.BostonPostCard h3 a,.BostonPostCard
 h4 a,.BostonPostCard h5 a,.BostonPostCard h6 a{color:#3a3e43;}.RightAdRail .BostonPostCard h1,.RightAdRail .BostonPostCard h2,.RightAdRail .BostonPostCard h5{background-color:#ffc845;color:#3a3e43;}.RightAdRail .BostonPostCard h3,.RightAdRail .BostonPostCard
 h4,.RightAdRail .BostonPostCard h6{background-color:#7d7d7d;color:#fff;}.FullWidth .h3,.fullwidth .h3,.MainColumn .h3,.maincolumn .h3,.MiddleColumn .h3,.middlecolumn .h3,.RightColumn .h3,.rightcolumn .h3,.ColumnFifty .h3,.columnfifty .h3{background-color:#ffc845!important;}.top1,.boxheader{background:#7d7d7d;color:#fff!important;}.boxcontent{border-bottom:1px
...
<p><a href="#top"><img src="9643-image.png" border="0" alt=""> ページのトップへ</a></p>
<hr>
...
<p><img src="9646-image.png" alt=""></p>
...
<p><img src="9650-image.png" alt=""> <br>
<br>
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">csharp</span>
<pre class="hidden"><code class="csharp">using System.Linq;</code></pre>
<pre id="codePreview" class="csharp"><code class="csharp">using System.Linq;</code></pre>
</div>
</div>
<div class="endscriptcode">&nbsp;</div>
</div>
...
<p><strong>図 9. ページの編集開始</strong></p>
