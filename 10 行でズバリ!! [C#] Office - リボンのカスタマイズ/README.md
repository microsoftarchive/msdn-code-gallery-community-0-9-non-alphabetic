...
<style><!-- ﻿.showRatings{border-bottom:silver 1px solid;background-color:#f0f0f0;text-align:left;width:100%;height:28px;vertical-align:bottom;}.showRatings_right{z-index:99;float:right;} ﻿.ShareThisMainPanel{text-align:left;float:left;}.ShareThis_RootButton{cursor:pointer;border:solid
 ...
 h1{line-height:130%;}.BostonPostCard h6{font-size:95%;line-height:120%;padding:0 0 1px 0;} ﻿#BodyBackground{background:#fff url('../images/logos_and_bg.png') repeat-x 0 -100px;}#JelloWrapper{background:url('../images/bg_branding_msdn_office.jpg') no-repeat
 right top;}.BrandLogo a{background:url('../images/logos_and_bg.png') no-repeat 0 -23px;display:block;height:27px;margin-top:-1px;width:94px;}.BrandLogo span{display:none;}.BrandLogo,.BrandLogo a,.BrandLogo a:link,.BrandLogo a:visited,.BrandLogo a:hover,.BrandLogo
