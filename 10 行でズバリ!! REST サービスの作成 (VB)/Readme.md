...
<pre class="hidden"><code class="csharp">'-- サービスコントラクト
&lt;ServiceContract()&gt; _
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">Imports System.ServiceModel.Web
...
End Class</code></pre>
<pre id="codePreview" class="vb"><code class="csharp">Imports System.ServiceModel.Web
...
<div class="pluginEditHolderLink">Edit Script</div>
<span class="hidden">vb</span>
<pre class="hidden"><code class="csharp">&lt;ServiceContract()&gt; _
Public Interface IOrderService
  &lt;OperationContract()&gt; _
  Function GetOne(ByVal id As String) As OrderItem
End Interface
...
<p>Web.config を開き、下記の通り、system.ServiceModel の要素をすべて削除しておきましょう。</p>
